...
Les principes d'architecture transversaux s'appliquent à toutes les données du système d'information sanitaire. Ils se traduisent en règles spécifiques. Chaque principe vit dans le référentiel : `04_architecture-repository/02_architecture-elements/motivation/principles/da-XX.md`.
