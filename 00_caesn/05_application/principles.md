...
Les principes suivants s'appliquent à toute application ou plateforme numérique du secteur santé. Chaque principe vit dans le référentiel : `04_architecture-repository/02_architecture-elements/motivation/principles/aa-XX.md`.
