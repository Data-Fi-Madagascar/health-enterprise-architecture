...
- **Art. 11 — Résidence de la donnée** : hébergement souverain sur le territoire national, chiffrement de bout en bout ([ART-7](../../04_architecture-repository/04_patterns/artsn-rules/art-7.md), [STD-0002](../../01_cnisn/05_standards/std-0002-securite-chiffrement.md)).
...
- **Art. 13 — Sécurité et traçabilité** : journalisation, authentification, garanties transactionnelles ([ART-9](../../04_architecture-repository/04_patterns/artsn-rules/art-9.md), [ADR-0008](../../01_cnisn/06_decisions/adr-0008-atna.md)).
