...
**Option A (recommandée, retenue) : la capabilité CAP-18 « Coordination intersectorielle (One Health) » a été créée** (voir `04_architecture-repository/02_architecture-elements/strategy/capabilities/cap-18.md`).
