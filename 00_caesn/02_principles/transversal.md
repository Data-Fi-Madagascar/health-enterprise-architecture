...
Le cadre repose sur douze principes d'architecture transversaux. Chaque initiative numérique doit être évaluée selon sa conformité à ces principes. Chaque principe vit dans le référentiel : `04_architecture-repository/principes/pa-XX.md`.
