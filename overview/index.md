...
| [Flux de valeur](../value-streams/) | Les 4 flux de valeur nationaux (VS-01 à VS-04) |
| [Principes](../principles/) | Principes d'architecture transversaux (PA) et principes de domaine (PD) |
| [Capabilités](../capabilities/) | Catalogue CAP-01 à CAP-16, maturité, architecture runway |
| [Données](../data/) | Principes DA, domaines de données, référentiels, gouvernance |
| [Application](../application/) | Principes AA, paysage applicatif cible, services partagés |
| [Portefeuille](../portfolio/) | Registre des initiatives, fiche initiative, priorisation |
| [Gouvernance](../governance/) | Comité National, Bureau de Réalisation de la Valeur, responsabilités |
| [Décisions](../decisions/) | Architecture Decision Records (ADR) |
| [Normes](../standards/) | Standards et règles d'homologation |
| [Annexes](../annexes/) | Matrice de lecture, glossaire |
