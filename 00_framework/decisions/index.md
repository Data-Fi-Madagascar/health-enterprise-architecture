...
Un ADR est produit lorsque le Comité National d'Architecture Santé Numérique statue sur un arbitrage, une homologation, un standard, une dérogation ou un choix technique structurant. Les ADR applicables au domaine applicatif sont mentionnés dans [`../application/index.md`](../application/index.md).
