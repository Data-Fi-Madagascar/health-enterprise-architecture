...
Chaque flux mobilise plusieurs capabilités. Voir la [lecture des capabilités par flux](../capabilities/index.md#lecture-des-capabilités-par-flux-de-valeur).

## Liens

- [Modèle de valeur](../overview/value-model.md)
- [Principes d'architecture](../principles/index.md)