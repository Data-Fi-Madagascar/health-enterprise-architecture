...
*Composants applicatifs : 04_architecture-repository/composants/.*
...
- **PT-03** : Profil technique national (`04_architecture-repository/profils/pt-03.md`)
...
- **PT-08** : Profil technique national (`04_architecture-repository/profils/pt-08.md`)
...
- **PT-10** : Profil technique national (`04_architecture-repository/profils/pt-10.md`)
- **CMP-12** : Registre d'éligibilité et de couverture (CSU : ART-4C) (`04_architecture-repository/composants/cmp-12.md`)
- **PT-11** : Profil technique national (`04_architecture-repository/profils/pt-11.md`)
...
- **PRC-01** : Accès, orientation et admission du patient (`04_architecture-repository/processus/prc-01.md`)
- **PRC-02** : Prestation des soins cliniques (`04_architecture-repository/processus/prc-02.md`)
- **PRC-03** : Continuité, suivi et qualité des soins (`04_architecture-repository/processus/prc-03.md`)
- **PRC-04** : Veille, prévention et surveillance sanitaire (`04_architecture-repository/processus/prc-04.md`)
- **PRC-05** : Alerte, investigation et riposte (`04_architecture-repository/processus/prc-05.md`)
- **PRC-06** : Clôture et capitalisation des épisodes (`04_architecture-repository/processus/prc-06.md`)
- **PRC-07** : Identification et droits des bénéficiaires (`04_architecture-repository/processus/prc-07.md`)
- **PRC-08** : Financement et exemption au point de service (`04_architecture-repository/processus/prc-08.md`)
- **PRC-09** : Remboursement et régulation des mécanismes (`04_architecture-repository/processus/prc-09.md`)
- **PRC-10** : Planification et allocation des ressources (`04_architecture-repository/processus/prc-10.md`)
- **PRC-11** : Suivi et pilotage de la performance (`04_architecture-repository/processus/prc-11.md`)
- **PRC-12** : Redevabilité et amélioration continue (`04_architecture-repository/processus/prc-12.md`)
