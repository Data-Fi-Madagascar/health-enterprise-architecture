...
Le CNISN s'inscrit dans un cadre juridique national et continental structuré. La **Loi n°2014-038** sur la protection des données à caractère personnel (2015) et son décret d'application 2023-1541 fixent les règles de protection des données personnelles, incluant les données de santé. La **Convention de Malabo** (ratifiée par la loi 2024-004) renforce le cadre transfrontalier. La **Stratégie Nationale de Santé Digitale 2023-2027** définit les orientations stratégiques que le CNISN décline en principes d'interopérabilité sectorielle.
