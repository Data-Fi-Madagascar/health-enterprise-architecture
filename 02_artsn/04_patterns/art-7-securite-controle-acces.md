...
related: ["ABB-CONFIANCE-AUTORISATION"]
---
...
- **Rattachement** : [CAP-15: Cybersécurité, confidentialité et gouvernance des données personnelles](../../04_architecture-repository/02_architecture-elements/strategy/capabilities/cap-15.md) (cybersécurité et gouvernance de la sécurité).
...
- **Déduit selon** : [ENF-1: Résilience à l'instabilité réseau](../../04_architecture-repository/03_requirements/enf-1.md) (sécurité locale).
- **Statut : Stable.**
...
- [PT-12 : Audit, provenance et traçabilité](../../04_architecture-repository/05_building-blocks/sbb/legacy-profiles/pt-12.md)
