...
- **Rattachement** : recouvre partiellement [CAP-07: Protection financière, couverture santé universelle](../../04_architecture-repository/capabilites/cap-07.md) (protection financière).
...
- **Déduit selon** : [ENF-2: Intégrité des flux et traçabilité des valeurs](../../04_architecture-repository/exigences/enf-2.md) (grade comptable anti-fraude).
