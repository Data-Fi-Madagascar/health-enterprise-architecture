...
| 6 | Infrastructure | 35 % | Initial | Hébergement souverain non confirmé ; cloud souverain en cours de cadrage ([ART-7](../../04_architecture-repository/chapitres/art-7.md)) |
...
| Infrastructure (35 %) | Hébergement souverain non confirmé | Sous-section « Hébergement souverain et cloud souverain » de [ART-7](../../04_architecture-repository/chapitres/art-7.md) (réf [STD-0002](../../01_cnisn/05_standards/std-0002-securite-chiffrement.md)) ; [plateforme PHC](../../00_caesn/07_governance/instances-sectorielles.md) |
