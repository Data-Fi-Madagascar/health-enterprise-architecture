...
|-----------------|---------------|-----------------------|-----------|
| **Resilient** (résiliente) | Disponibilité, reprise, sécurité | Hébergement souverain, chiffrement, journalisation, garanties transactionnelles | [ART-7](../../04_architecture-repository/04_patterns/artsn-rules/art-7.md), [ART-9](../../04_architecture-repository/04_patterns/artsn-rules/art-9.md), [STD-0002](../../01_cnisn/05_standards/std-0002-securite-chiffrement.md), [ADR-0008](../../01_cnisn/06_decisions/adr-0008-atna.md) |
...
| **Digital & Data** (données) | Données comme actif souverain | Résidence de la donnée, architecture de l'information sanitaire | [ART-7](../../04_architecture-repository/04_patterns/artsn-rules/art-7.md) (résidence), [Architecture des données CAESN](../../00_caesn/04_data/index.md) |
...
|---------------------------|----------|--------------------|-------------------|
| Registre des bénéficiaires (Client Registry) | Identité unique du patient | [ART-4A](../../04_architecture-repository/04_patterns/artsn-rules/art-4a.md) (Résolution d'identité) | [STD-0005](../../01_cnisn/05_standards/std-0005-identite-pixm.md), [ADR-0004](../../01_cnisn/06_decisions/adr-0004-identite.md), [ADR-0006](../../01_cnisn/06_decisions/adr-0006-inp.md) |
| Registre des formations sanitaires (Facility Registry) | Identité des lieux de soins | [ART-4](../../04_architecture-repository/04_patterns/artsn-rules/art-4.md) (Référentiels) | [STD-0001](../../01_cnisn/05_standards/std-0001-interopabilite-fhir.md) |
| Registre des professionnels de santé (Health Worker Registry) | Identité des prestataires | [ART-4](../../04_architecture-repository/04_patterns/artsn-rules/art-4.md) (Référentiels) | [STD-0001](../../01_cnisn/05_standards/std-0001-interopabilite-fhir.md) |
| Couche d'échange (Interoperability Layer) | Routage et transformation des messages | [ART-2](../../04_architecture-repository/04_patterns/artsn-rules/art-2.md) (Médiation), [ART-3](../../04_architecture-repository/04_patterns/artsn-rules/art-3.md) (Historisation) | [STD-0003](../../01_cnisn/05_standards/std-0003-x-road.md), [ADR-0001](../../01_cnisn/06_decisions/adr-0001-x-road.md), [STD-0001](../../01_cnisn/05_standards/std-0001-interopabilite-fhir.md) |
| Service de terminologie | Codes et classifications communs | [ART-4](../../04_architecture-repository/04_patterns/artsn-rules/art-4.md) (Référentiels) | [STD-0006](../../01_cnisn/05_standards/std-0006-terminologie.md), [STD-0007](../../01_cnisn/05_standards/std-0007-snomed-ct.md) |
| Dossier partagé (Shared Health Record) | Repository longitudinal patient | [ART-1](../../04_architecture-repository/04_patterns/artsn-rules/art-1.md) (Intégration), [ART-3](../../04_architecture-repository/04_patterns/artsn-rules/art-3.md) (Historisation) | [STD-0001](../../01_cnisn/05_standards/std-0001-interopabilite-fhir.md), [STD-0005](../../01_cnisn/05_standards/std-0005-identite-pixm.md) |
| Système d'information sanitaire (HMIS) | Données agrégées et tableaux de bord | [ART-6](../../04_architecture-repository/04_patterns/artsn-rules/art-6.md) (Analytique) | [STD-0004](../../01_cnisn/05_standards/std-0004-madx.md), [ADR-0003](../../01_cnisn/06_decisions/adr-0003-fhir.md) |
| Gestion logistique (LMIS) | Visibilité sur les produits de santé | [ART-10](../../04_architecture-repository/04_patterns/artsn-rules/art-10.md) (Logistique) | [STD-0001](../../01_cnisn/05_standards/std-0001-interopabilite-fhir.md) |
| Cadre de confiance-sécurité | Authentification, autorisation, journalisation | [ART-7](../../04_architecture-repository/04_patterns/artsn-rules/art-7.md) (Sécurité), [ART-4B](../../04_architecture-repository/04_patterns/artsn-rules/art-4b.md) (Bases d'autorisation) | [STD-0002](../../01_cnisn/05_standards/std-0002-securite-chiffrement.md), [ADR-0008](../../01_cnisn/06_decisions/adr-0008-atna.md), [ADR-0005](../../01_cnisn/06_decisions/adr-0005-consentement.md) |

## 3. Articulation : comment l'HEA répond à REDDHI

L'HEA ne « copie » pas REDDHI ; elle l'opérationnalise à trois niveaux cohérents :

1. **Niveau stratégique (CAESN).** Les principes REDDHI (résilience, essence, possession nationale) sont repris par les principes d'architecture (notamment PA-05 souveraineté, PA-06 confiance) et par la gouvernance sous la tutelle du CNASN. La résidence de la donnée ([ART-7](../../04_architecture-repository/04_patterns/artsn-rules/art-7.md)) traduit l'exigence « données comme actif souverain ».
