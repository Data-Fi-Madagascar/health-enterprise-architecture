...
Il s'inscrit [entre le plateau 1 et le plateau 2](../../04_architecture-repository/07_migration/plateaux/pl-01.md), et touche la [région sanitaire](../../04_architecture-repository/02_architecture-elements/business/locations/loc-04.md) comme la [capacité « Offre de soins et continuité »](../../04_architecture-repository/02_architecture-elements/strategy/capabilities/cap-01.md). Il appelle une stratégie de résilience (mode hors-ligne, synchronisation) dès la conception.

## Plateau source et cible

S'inscrit [PL-01](../../04_architecture-repository/07_migration/plateaux/pl-01.md), [PL-02](../../04_architecture-repository/07_migration/plateaux/pl-02.md).
