...
id: art-0-accords-partage
domain: 02_artsn
version: "0.1.0"
status: draft
last_reviewed: 2026-08-08
owner: DEPSI
tags: [artsn, chapitres, art-0, partage, niveau-3]
---
...
- **Déduit selon** : [ENF-4](../02_exigences-contextuelles.md#enf-4--cloisonnement-inter-institutionnel-et-étanchéité-des-données-one-health) (cloisonnement One Health).
- **Statut : Proposition ouverte.**

## Liens

- [Index des chapitres](./index.md)
- [Exigences contextuelles — ENF-4](../02_exigences-contextuelles.md)
- [Gouvernance](../06_gouvernance.md)
