...
Les exigences contextuelles traduisent les contraintes nationales (géographie, réseau, interopérabilité inter-institutionnelle) en obligations qui s'imposent à tout chapitre et à toute solution. Chaque exigence vit dans le référentiel : `04_architecture-repository/03_requirements/enf-X.md`.
...
**Statut : Stable.** — appliqué par [F.1](../../04_architecture-repository/04_patterns/foundations/f-1.md), [ART-1](../../04_architecture-repository/04_patterns/artsn-rules/art-1.md), Couche 2 (point de service).
...
- [CAP-14: Interopérabilité, référentiels nationaux et infrastructure numérique partagée](../../04_architecture-repository/02_architecture-elements/strategy/capabilities/cap-14.md) — Interopérabilité, référentiels nationaux et infrastructure numérique partagée
- [CAP-15: Cybersécurité, confidentialité et gouvernance des données personnelles](../../04_architecture-repository/02_architecture-elements/strategy/capabilities/cap-15.md) — Cybersécurité, confidentialité et gouvernance des données personnelles

#### Parties prenantes concernées

- [PP-05: Agent de santé](../../04_architecture-repository/02_architecture-elements/motivation/stakeholders/pp-05.md) — Agent de santé
- [PP-06: Formation sanitaire](../../04_architecture-repository/02_architecture-elements/motivation/stakeholders/pp-06.md) — Formation sanitaire
- [PP-10: Équipes techniques (DEPSI / SIS)](../../04_architecture-repository/02_architecture-elements/motivation/stakeholders/pp-10.md) — Équipes techniques (DEPSI / SIS)

#### Fondations et chapitres garants

- **F.1** — Résilience face à la réalité géographique du pays
- [ART-1: Intégration et ingestion](../../04_architecture-repository/04_patterns/artsn-rules/art-1.md) — Intégration et ingestion
- [ART-3: Historisation événementielle et profils de déploiement](../../04_architecture-repository/04_patterns/artsn-rules/art-3.md) — Historisation événementielle et profils de déploiement
- [ART-7: Sécurité, contrôle d'accès et résidence de la donnée](../../04_architecture-repository/04_patterns/artsn-rules/art-7.md) — Sécurité, contrôle d'accès et résidence de la donnée
...
**Statut : Stable.** — appliqué par [ART-9 (garanties transactionnelles)](../../04_architecture-repository/04_patterns/artsn-rules/art-9.md), [ART-4C (éligibilité)](../../04_architecture-repository/04_patterns/artsn-rules/art-4c.md), [ART-8C (agrégation par lot)](../../04_architecture-repository/04_patterns/artsn-rules/art-8c.md).
...
- [CAP-12: Finances publiques, budget et allocation des ressources](../../04_architecture-repository/02_architecture-elements/strategy/capabilities/cap-12.md) — Finances publiques, budget et allocation des ressources
- [CAP-13: Système d'information sanitaire, données et recherche](../../04_architecture-repository/02_architecture-elements/strategy/capabilities/cap-13.md) — Système d'information sanitaire, données et recherche

#### Parties prenantes concernées

- [PP-02: Ménage et famille](../../04_architecture-repository/02_architecture-elements/motivation/stakeholders/pp-02.md) — Ménage et famille
- [PP-06: Formation sanitaire](../../04_architecture-repository/02_architecture-elements/motivation/stakeholders/pp-06.md) — Formation sanitaire
- [PP-08: Partenaires techniques et financiers](../../04_architecture-repository/02_architecture-elements/motivation/stakeholders/pp-08.md) — Partenaires techniques et financiers

#### Fondations et chapitres garants

- [ART-9: Garanties transactionnelles fortes](../../04_architecture-repository/04_patterns/artsn-rules/art-9.md) — Garanties transactionnelles fortes
- **ART-4C** — Éligibilité et couverture
- **ART-8C** — Agrégation par lot
...
**Statut : Stable.** — appliqué par [ART-4A (résolution d’identité)](../../04_architecture-repository/04_patterns/artsn-rules/art-4a.md), [ART-2 (médiation)](../../04_architecture-repository/04_patterns/artsn-rules/art-2.md).
...
- [PP-01: Patient et usager](../../04_architecture-repository/02_architecture-elements/motivation/stakeholders/pp-01.md) — Patient et usager
- [PP-06: Formation sanitaire](../../04_architecture-repository/02_architecture-elements/motivation/stakeholders/pp-06.md) — Formation sanitaire
- [PP-10: Équipes techniques (DEPSI / SIS)](../../04_architecture-repository/02_architecture-elements/motivation/stakeholders/pp-10.md) — Équipes techniques (DEPSI / SIS)
...
- [ART-2: Médiation et normalisation](../../04_architecture-repository/04_patterns/artsn-rules/art-2.md) — Médiation et normalisation
...
**Statut : Stable.** — appliqué par [ART-0 (accords de partage)](../../04_architecture-repository/04_patterns/artsn-rules/art-0.md), [ART-4B (bases d’autorisation)](../../04_architecture-repository/04_patterns/artsn-rules/art-4b.md), [ART-4D (référentiel géospatial)](../../04_architecture-repository/04_patterns/artsn-rules/art-4d.md).
...
- [PP-03: Population](../../04_architecture-repository/02_architecture-elements/motivation/stakeholders/pp-03.md) — Population
- [PP-07: District, région et Ministère](../../04_architecture-repository/02_architecture-elements/motivation/stakeholders/pp-07.md) — District, région et Ministère
- [PP-08: Partenaires techniques et financiers](../../04_architecture-repository/02_architecture-elements/motivation/stakeholders/pp-08.md) — Partenaires techniques et financiers
- [PP-10: Équipes techniques (DEPSI / SIS)](../../04_architecture-repository/02_architecture-elements/motivation/stakeholders/pp-10.md) — Équipes techniques (DEPSI / SIS)

#### Fondations et chapitres garants

- [ART-0: Accords de partage inter-institutionnels](../../04_architecture-repository/04_patterns/artsn-rules/art-0.md) — Accords de partage inter-institutionnels
...
- [ART-2: Médiation et normalisation](../../04_architecture-repository/04_patterns/artsn-rules/art-2.md) — Médiation et normalisation
- [ART-6: Analytique et restitution](../../04_architecture-repository/04_patterns/artsn-rules/art-6.md) — Analytique et restitution
- **ART-8B** — Modélisation de relations en graphe
- **ART-8D** — Chorégraphie inter-institutionnelle
- [ART-4: Référentiels de métadonnées de gestion](../../04_architecture-repository/04_patterns/artsn-rules/art-4.md) — Référentiels de métadonnées de gestion
...
**Statut : Stable.** — appliqué par [ART-8A (orchestration de processus borné)](../../04_architecture-repository/04_patterns/artsn-rules/art-8a.md), [ART-5 (qualité des données)](../../04_architecture-repository/04_patterns/artsn-rules/art-5.md), [PT-14 (interopérabilité transfrontalière)](../../03_ptisn/03_profils/pt-14-interopabilite-transfrontaliere.md).
...
- [CAP-13: Système d'information sanitaire, données et recherche](../../04_architecture-repository/02_architecture-elements/strategy/capabilities/cap-13.md) — Système d'information sanitaire, données et recherche
- [CAP-16: Gestion du portefeuille d'initiatives numériques](../../04_architecture-repository/02_architecture-elements/strategy/capabilities/cap-16.md) — Gestion du portefeuille d'initiatives numériques
...
- [ART-8: Orchestration de processus](../../04_architecture-repository/04_patterns/artsn-rules/art-8.md) — Orchestration de processus
- [ART-5: Cohérence et qualité des données](../../04_architecture-repository/04_patterns/artsn-rules/art-5.md) — Cohérence et qualité des données
