...
- **ART-0 : Accords de partage** : Accords de partage inter-institutionnels (`04_architecture-repository/04_patterns/artsn-rules/art-0.md`)
- **ART-1 : Intégration et ingestion** : Intégration et ingestion (`04_architecture-repository/04_patterns/artsn-rules/art-1.md`)
- **ART-2 : Médiation et normalisation** : Médiation et normalisation (`04_architecture-repository/04_patterns/artsn-rules/art-2.md`)
- **ART-3 : Historisation événementielle** : Historisation événementielle et profils de déploiement (`04_architecture-repository/04_patterns/artsn-rules/art-3.md`)
- **ART-4 : Référentiels de métadonnées** : Référentiels de métadonnées de gestion (`04_architecture-repository/04_patterns/artsn-rules/art-4.md`)
- **ART-4A : Résolution d'identité** : Résolution d'identité (`04_architecture-repository/04_patterns/artsn-rules/art-4a.md`)
- **ART-4B : Bases d'autorisation** : Bases d'autorisation (`04_architecture-repository/04_patterns/artsn-rules/art-4b.md`)
- **ART-4C : Éligibilité et couverture** : Éligibilité et couverture (`04_architecture-repository/04_patterns/artsn-rules/art-4c.md`)
- **ART-4D : Référentiel géospatial** : Référentiel géospatial et d'exploitation partagé (`04_architecture-repository/04_patterns/artsn-rules/art-4d.md`)
- **ART-5 : Cohérence et qualité des données** : Cohérence et qualité des données (`04_architecture-repository/04_patterns/artsn-rules/art-5.md`)
- **ART-6 : Analytique et restitution** : Analytique et restitution (`04_architecture-repository/04_patterns/artsn-rules/art-6.md`)
- **ART-7 : Sécurité et contrôle d'accès** : Sécurité, contrôle d'accès et résidence de la donnée (`04_architecture-repository/04_patterns/artsn-rules/art-7.md`)
- **ART-8 : Orchestration de processus** : Orchestration de processus (`04_architecture-repository/04_patterns/artsn-rules/art-8.md`)
- **ART-8A : Orchestration de processus borné** : Orchestration de processus borné (`04_architecture-repository/04_patterns/artsn-rules/art-8a.md`)
- **ART-8B : Modélisation en graphe** : Modélisation de relations en graphe (`04_architecture-repository/04_patterns/artsn-rules/art-8b.md`)
- **ART-8C : Agrégation par lot** : Agrégation par lot (`04_architecture-repository/04_patterns/artsn-rules/art-8c.md`)
- **ART-8D : Chorégraphie inter-institutionnelle** : Chorégraphie inter-institutionnelle (`04_architecture-repository/04_patterns/artsn-rules/art-8d.md`)
- **ART-9 : Garanties transactionnelles** : Garanties transactionnelles fortes (`04_architecture-repository/04_patterns/artsn-rules/art-9.md`)
