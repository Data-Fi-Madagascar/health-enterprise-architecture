...
- **ART-1 : Intégration et ingestion** : Intégration et ingestion (`04_architecture-repository/chapitres/art-1.md`)
- **ART-2 : Médiation et normalisation** : Médiation et normalisation (`04_architecture-repository/chapitres/art-2.md`)
- **ART-3 : Historisation événementielle** : Historisation événementielle et profils de déploiement (`04_architecture-repository/chapitres/art-3.md`)
- **ART-4 : Référentiels de métadonnées** : Référentiels de métadonnées de gestion (`04_architecture-repository/chapitres/art-4.md`)
...
- **ART-4C : Éligibilité et couverture** : Éligibilité et couverture (`04_architecture-repository/chapitres/art-4c.md`)
- **ART-4D : Référentiel géospatial** : Référentiel géospatial et d'exploitation partagé (`04_architecture-repository/chapitres/art-4d.md`)
- **ART-5 : Cohérence et qualité des données** : Cohérence et qualité des données (`04_architecture-repository/chapitres/art-5.md`)
- **ART-6 : Analytique et restitution** : Analytique et restitution (`04_architecture-repository/chapitres/art-6.md`)
- **ART-7 : Sécurité et contrôle d'accès** : Sécurité, contrôle d'accès et résidence de la donnée (`04_architecture-repository/chapitres/art-7.md`)
- **ART-8 : Orchestration de processus** : Orchestration de processus (`04_architecture-repository/chapitres/art-8.md`)
- **ART-8A : Orchestration de processus borné** : Orchestration de processus borné (`04_architecture-repository/chapitres/art-8a.md`)
- **ART-8B : Modélisation en graphe** : Modélisation de relations en graphe (`04_architecture-repository/chapitres/art-8b.md`)
- **ART-8C : Agrégation par lot** : Agrégation par lot (`04_architecture-repository/chapitres/art-8c.md`)
...
- **ART-9 : Garanties transactionnelles** : Garanties transactionnelles fortes (`04_architecture-repository/chapitres/art-9.md`)
