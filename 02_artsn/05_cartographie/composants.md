...
<!-- BEGIN:GENERATED mode=catalogue source=04_architecture-repository/composants/cmp-01.md,04_architecture-repository/composants/cmp-02.md,04_architecture-repository/composants/cmp-03.md,04_architecture-repository/composants/cmp-04.md,04_architecture-repository/composants/cmp-05.md,04_architecture-repository/composants/cmp-06.md,04_architecture-repository/composants/cmp-07.md,04_architecture-repository/composants/cmp-08.md,04_architecture-repository/composants/cmp-09.md,04_architecture-repository/composants/cmp-10.md,04_architecture-repository/composants/cmp-11.md,04_architecture-repository/composants/cmp-12.md,04_architecture-repository/composants/cmp-13.md,04_architecture-repository/composants/cmp-14.md,04_architecture-repository/composants/cmp-15.md,04_architecture-repository/composants/cmp-16.md,04_architecture-repository/composants/cmp-17.md,04_architecture-repository/composants/cmp-18.md,04_architecture-repository/composants/cmp-19.md,04_architecture-repository/composants/cmp-20.md,04_architecture-repository/composants/cmp-21.md,04_architecture-repository/composants/cmp-22.md,04_architecture-repository/composants/cmp-23.md,04_architecture-repository/composants/cmp-24.md,04_architecture-repository/composants/cmp-25.md -->
<!-- Généré par scripts/build_wrappers.py : ne pas éditer à la main -->

### Tableaux de bord & Portails nationaux

**Contenu normatif.** Ce composant agrège les projections analytiques (Couche 5) et expose des tableaux de bord unifiés pour le pilotage national : performance sanitaire, suivi CSU, gestion des ressources et veille environnementale. L'accès y est cloisonné par profil (décideurs, SIS, partenaires). Il interopère avec l'entrepôt Lakehouse ([CMP-03: Entrepôt Lakehouse & Projections analytiques (pipeline ETL, Lakehouse, projections)](../../04_architecture-repository/composants/cmp-03.md)) et le moteur analytique ([CMP-04: Moteur analytique & IA (IA prédictive, routeur alertes, Grand Livre)](../../04_architecture-repository/composants/cmp-04.md)).
...
- **Rattachement** : [ART-6](../../04_architecture-repository/chapitres/art-6.md) (projections analytiques), [CAP-INT-07: Accès et exposition des données analytiques](../../04_architecture-repository/capacites/cap-int-07.md), [CAP-INT-11: Qualité et réconciliation](../../04_architecture-repository/capacites/cap-int-11.md).
- **Processus soutenus** : [PRC-10: Planification et allocation des ressources](../../04_architecture-repository/processus/prc-10.md) (planification), [PRC-11: Suivi et pilotage de la performance](../../04_architecture-repository/processus/prc-11.md) (pilotage performance), [PRC-12: Redevabilité et amélioration continue](../../04_architecture-repository/processus/prc-12.md) (redevabilité).
- **Statut : Stable.**

### Centre de commande & Crises intersectorielles

**Contenu normatif.** Ce composant constitue le centre unique de supervision des alertes épidémiques et de coordination des crises intersectorielles (santé, élevage, environnement). Il agrège les signaux de la surveillance ([CMP-14: Registre des produits, intrants et indicateurs](../../04_architecture-repository/composants/cmp-14.md)), du moteur d'alertes ([CMP-04: Moteur analytique & IA (IA prédictive, routeur alertes, Grand Livre)](../../04_architecture-repository/composants/cmp-04.md)) et des registres de gouvernance ([CMP-17: Message broker asynchrone](../../04_architecture-repository/composants/cmp-17.md)), et fournit une vue en temps réel pour la prise de décision multi-ministérielle.
...
- **Rattachement** : [ART-5](../../04_architecture-repository/chapitres/art-5.md) (routeur alertes), [ART-0](../../04_architecture-repository/chapitres/art-0.md) (accords partage), [CAP-INT-07: Accès et exposition des données analytiques](../../04_architecture-repository/capacites/cap-int-07.md).
- **Processus soutenus** : [PRC-05: Alerte, investigation et riposte](../../04_architecture-repository/processus/prc-05.md) (alerte/investigation/riposte), [PRC-11: Suivi et pilotage de la performance](../../04_architecture-repository/processus/prc-11.md) (pilotage performance).
- **Statut : Stable.**

### Entrepôt Lakehouse & Projections analytiques

**Contenu normatif.** Ce composant assure le stockage analytique central (Lakehouse) en recevant les flux ETL depuis la Couche 4. Il exécute les projections tabulaires, la réconciliation du Grand Livre ([ART-9: Garanties transactionnelles fortes](../../04_architecture-repository/chapitres/art-9.md)) et alimente les tableaux de bord ([CMP-01: Tableaux de bord & Portails nationaux (performance, CSU, ressources, veille)](../../04_architecture-repository/composants/cmp-01.md)). La séparation stricte CQRS ([ART-6: Analytique et restitution](../../04_architecture-repository/chapitres/art-6.md)) interdit tout traitement transactionnel.

**Discipline de mise en œuvre.** Il garantit l'intégrité analytique ([ENF-5: Coordination des processus complexes décentralisés et asynchrones](../../04_architecture-repository/exigences/enf-5.md)) et l'irréversibilité du masquage des identités. Toute analyse officielle passe par cet entrepôt.

- **Rattachement** : [ART-6](../../04_architecture-repository/chapitres/art-6.md) (CQRS), [ART-9](../../04_architecture-repository/chapitres/art-9.md) (Grand Livre), [CAP-INT-07: Accès et exposition des données analytiques](../../04_architecture-repository/capacites/cap-int-07.md), [CAP-INT-11: Qualité et réconciliation](../../04_architecture-repository/capacites/cap-int-11.md).
- **Processus soutenus** : [PRC-09: Remboursement et régulation des mécanismes](../../04_architecture-repository/processus/prc-09.md) (remboursement), [PRC-11: Suivi et pilotage de la performance](../../04_architecture-repository/processus/prc-11.md) (pilotage).
- **Statut : Stable.**

### Moteur analytique & IA

**Contenu normatif.** Ce composant exécute les modèles prédictifs (IA), le routeur d'escalade et d'alertes ([ART-5: Cohérence et qualité des données](../../04_architecture-repository/chapitres/art-5.md)) et la réconciliation analytique du Grand Livre ([ART-9: Garanties transactionnelles fortes](../../04_architecture-repository/chapitres/art-9.md)). Il consomme l'entrepôt Lakehouse ([CMP-03: Entrepôt Lakehouse & Projections analytiques (pipeline ETL, Lakehouse, projections)](../../04_architecture-repository/composants/cmp-03.md)) et alimente le centre de commande ([CMP-02: Centre de commande & Crises intersectorielles (alertes, crises, veille)](../../04_architecture-repository/composants/cmp-02.md)) ainsi que la facturation ([CMP-10: Registre des terminologies](../../04_architecture-repository/composants/cmp-10.md)).

**Discipline de mise en œuvre.** Il sépare l'inférence analytique du stockage et garantit la traçabilité des modèles (versionnage, données d'entraînement) ainsi que l'audit des décisions automatisées ([ENF-2: Intégrité des flux et traçabilité des valeurs](../../04_architecture-repository/exigences/enf-2.md), [ENF-5: Coordination des processus complexes décentralisés et asynchrones](../../04_architecture-repository/exigences/enf-5.md)).

- **Rattachement** : [ART-5](../../04_architecture-repository/chapitres/art-5.md) (alertes), [ART-9](../../04_architecture-repository/chapitres/art-9.md) (Grand Livre), [CAP-INT-07: Accès et exposition des données analytiques](../../04_architecture-repository/capacites/cap-int-07.md), [CAP-INT-10: Provenance, audit et traçabilité](../../04_architecture-repository/capacites/cap-int-10.md).
- **Processus soutenus** : [PRC-09: Remboursement et régulation des mécanismes](../../04_architecture-repository/processus/prc-09.md) (remboursement), [PRC-05: Alerte, investigation et riposte](../../04_architecture-repository/processus/prc-05.md) (alerte/riposte).
- **Statut : Stable.**
...
**Discipline de mise en œuvre.** Il garantit la cohérence topologique du graphe national et la résilience spatiale ([ENF-4: Cloisonnement inter-institutionnel et étanchéité des données (One Health)](../../04_architecture-repository/exigences/enf-4.md)). Toute requête de navigation relationnelle passe par ce composant.

- **Rattachement** : [ART-8B](../../04_architecture-repository/chapitres/art-8b.md) (graphe), [ART-4D](../../04_architecture-repository/chapitres/art-4d.md) (spatio-temporel), [CAP-INT-03: Échange et médiation inter-systèmes](../../04_architecture-repository/capacites/cap-int-03.md), [CAP-INT-12: Conformité et tests d’interopérabilité](../../04_architecture-repository/capacites/cap-int-12.md).
- **Statut : Stable.**

### Intégration, Médiation, API Gateway, Broker & Registre schémas

**Contenu normatif.** Ce composant constitue le point d'entrée unique de la plateforme : API Gateway (contrats, throttling, authentification), message broker asynchrone (files d'attente, durabilité), registre de schémas (F.3 — versioning, compatibilité ascendante/descendante) et moteur de médiation sémantique ([ART-2](../../04_architecture-repository/chapitres/art-2.md) transformation, normalisation, enrichissement).

**Discipline de mise en œuvre.** Il forme la bordure de la plateforme ; tout flux entrant ou sortant le traverse. Il garantit l'éradication des silos (F.3) et la conformité aux contrats ([ENF-1: Résilience à l'instabilité réseau](../../04_architecture-repository/exigences/enf-1.md), [ENF-3: Unicité de l'identité et résilience face à la fragmentation applicative](../../04_architecture-repository/exigences/enf-3.md)).

- **Rattachement** : [ART-1](../../04_architecture-repository/chapitres/art-1.md) (ingestion), [ART-2](../../04_architecture-repository/chapitres/art-2.md) (médiation), [F.3](../../04_architecture-repository/fondations/f-3.md) (schémas), [CAP-INT-01: Résolution d’identité du bénéficiaire](../../04_architecture-repository/capacites/cap-int-01.md), [CAP-INT-03: Échange et médiation inter-systèmes](../../04_architecture-repository/capacites/cap-int-03.md).
- **Statut : Stable.**
...
- **Rattachement** : [ART-8A](../../04_architecture-repository/chapitres/art-8a.md) (orchestrateur de parcours), [CAP-INT-08: Confiance, sécurité et autorisation](../../04_architecture-repository/capacites/cap-int-08.md).
- **Processus soutenus** : [PRC-04: Veille, prévention et surveillance sanitaire](../../04_architecture-repository/processus/prc-04.md) (soins), [PRC-05: Alerte, investigation et riposte](../../04_architecture-repository/processus/prc-05.md) (pharmacie), [PRC-06: Clôture et capitalisation des épisodes](../../04_architecture-repository/processus/prc-06.md) (logistique).
- **Statut : Stable.**
...
- **Rattachement** : [ART-4](../../04_architecture-repository/chapitres/art-4.md) (référentiel des métadonnées), [CAP-INT-09: Gestion des consentements et bases d’autorisation](../../04_architecture-repository/capacites/cap-int-09.md).
- **Processus soutenus** : [PRC-04: Veille, prévention et surveillance sanitaire](../../04_architecture-repository/processus/prc-04.md) (soins), [PRC-05: Alerte, investigation et riposte](../../04_architecture-repository/processus/prc-05.md) (pharmacie).
- **Statut : Stable.**

### Référentiel des métadonnées d'exploitation ([ART-4: Référentiels de métadonnées de gestion](../../04_architecture-repository/chapitres/art-4.md))
...
- **Rattachement** : [ART-4](../../04_architecture-repository/chapitres/art-4.md) (référentiel des métadonnées), [CAP-INT-09: Gestion des consentements et bases d’autorisation](../../04_architecture-repository/capacites/cap-int-09.md).
- **Processus soutenus** : [PRC-07: Identification et droits des bénéficiaires](../../04_architecture-repository/processus/prc-07.md) (production données), [PRC-08: Financement et exemption au point de service](../../04_architecture-repository/processus/prc-08.md) (qualité).
- **Statut : Stable.**
...
- **Rattachement** : [ART-4A](../../04_architecture-repository/chapitres/art-4a.md) (INP), [CAP-INT-09: Gestion des consentements et bases d’autorisation](../../04_architecture-repository/capacites/cap-int-09.md).
- **Processus soutenus** : [PRC-04: Veille, prévention et surveillance sanitaire](../../04_architecture-repository/processus/prc-04.md) (soins), [PRC-05: Alerte, investigation et riposte](../../04_architecture-repository/processus/prc-05.md) (pharmacie), [PRC-06: Clôture et capitalisation des épisodes](../../04_architecture-repository/processus/prc-06.md) (logistique).
- **Statut : Stable.**
...
- **Rattachement** : [ART-4C](../../04_architecture-repository/chapitres/art-4c.md) (éligibilité/couverture), [CAP-INT-09: Gestion des consentements et bases d’autorisation](../../04_architecture-repository/capacites/cap-int-09.md).
- **Processus soutenus** : [PRC-09: Remboursement et régulation des mécanismes](../../04_architecture-repository/processus/prc-09.md) (finance), [PRC-10: Planification et allocation des ressources](../../04_architecture-repository/processus/prc-10.md) (planification).
- **Statut : Stable.**
...
- **Rattachement** : [ART-4](../../04_architecture-repository/chapitres/art-4.md) (référentiel des métadonnées), [CAP-INT-09: Gestion des consentements et bases d’autorisation](../../04_architecture-repository/capacites/cap-int-09.md).
- **Processus soutenus** : [PRC-05: Alerte, investigation et riposte](../../04_architecture-repository/processus/prc-05.md) (pharmacie), [PRC-06: Clôture et capitalisation des épisodes](../../04_architecture-repository/processus/prc-06.md) (logistique).
- **Statut : Stable.**
...
- **Rattachement** : [ART-5](../../04_architecture-repository/chapitres/art-5.md) (routeur d'escalade), [CAP-INT-10: Provenance, audit et traçabilité](../../04_architecture-repository/capacites/cap-int-10.md).
- **Processus soutenus** : [PRC-04: Veille, prévention et surveillance sanitaire](../../04_architecture-repository/processus/prc-04.md) (soins), [PRC-05: Alerte, investigation et riposte](../../04_architecture-repository/processus/prc-05.md) (pharmacie), [PRC-06: Clôture et capitalisation des épisodes](../../04_architecture-repository/processus/prc-06.md) (logistique).
- **Statut : Stable.**
...
- **Rattachement** : [ART-8C](../../04_architecture-repository/chapitres/art-8c.md) (Netting), [CAP-INT-10: Provenance, audit et traçabilité](../../04_architecture-repository/capacites/cap-int-10.md).
- **Processus soutenus** : [PRC-04: Veille, prévention et surveillance sanitaire](../../04_architecture-repository/processus/prc-04.md) (soins), [PRC-05: Alerte, investigation et riposte](../../04_architecture-repository/processus/prc-05.md) (pharmacie), [PRC-06: Clôture et capitalisation des épisodes](../../04_architecture-repository/processus/prc-06.md) (logistique).
- **Statut : Stable.**
...
- **Rattachement** : [ENF-1: Resilience a l'instabilite reseau](../../04_architecture-repository/exigences/enf-1.md), [F-1: Resilience face a la realite geographique du pays](../../04_architecture-repository/fondations/f-1.md).
- **Processus soutenus** : [PRC-01: Acces, orientation et admission du patient](../../04_architecture-repository/processus/prc-01.md) (acces et admission), [PRC-02: Prestation des soins cliniques](../../04_architecture-repository/processus/prc-02.md) (prestation des soins), [PRC-03: Continuite, suivi et qualite des soins](../../04_architecture-repository/processus/prc-03.md) (suivi et qualite), [PRC-06: Cloture et capitalisation des episodes](../../04_architecture-repository/processus/prc-06.md) (cloture et capitalisation).
- **Statut : Brouillon.**
...
- **Rattachement** : [ENF-1: Resilience a l'instabilite reseau](../../04_architecture-repository/exigences/enf-1.md), [F-1: Resilience face a la realite geographique du pays](../../04_architecture-repository/fondations/f-1.md).
- **Processus soutenus** : [PRC-02: Prestation des soins cliniques](../../04_architecture-repository/processus/prc-02.md) (dispensation aux soins), [PRC-05: Alerte, investigation et riposte](../../04_architecture-repository/processus/prc-05.md) (pharmacovigilance et riposte).
- **Statut : Brouillon.**
...
- **Rattachement** : [ENF-1: Resilience a l'instabilite reseau](../../04_architecture-repository/exigences/enf-1.md), [F-1: Resilience face a la realite geographique du pays](../../04_architecture-repository/fondations/f-1.md).
- **Processus soutenus** : [PRC-01: Acces, orientation et admission du patient](../../04_architecture-repository/processus/prc-01.md) (acces au beneficiaire), [PRC-02: Prestation des soins cliniques](../../04_architecture-repository/processus/prc-02.md) (soins de proximite), [PRC-03: Continuite, suivi et qualite des soins](../../04_architecture-repository/processus/prc-03.md) (suivi communautaire).
- **Statut : Brouillon.**
...
- **Rattachement** : [ENF-1: Resilience a l'instabilite reseau](../../04_architecture-repository/exigences/enf-1.md), [F-1: Resilience face a la realite geographique du pays](../../04_architecture-repository/fondations/f-1.md).
- **Processus soutenus** : [PRC-01: Acces, orientation et admission du patient](../../04_architecture-repository/processus/prc-01.md) (acces aux services), [PRC-07: Identification et droits des beneficiaires](../../04_architecture-repository/processus/prc-07.md) (identification et droits), [PRC-08: Financement et exemption au point de service](../../04_architecture-repository/processus/prc-08.md) (financement et exemption).
- **Statut : Brouillon.**
...
- **Rattachement** : [ENF-1: Resilience a l'instabilite reseau](../../04_architecture-repository/exigences/enf-1.md), [F-1: Resilience face a la realite geographique du pays](../../04_architecture-repository/fondations/f-1.md).
- **Processus soutenus** : [PRC-05: Alerte, investigation et riposte](../../04_architecture-repository/processus/prc-05.md) (approvisionnement et riposte), [PRC-10: Planification et allocation des ressources](../../04_architecture-repository/processus/prc-10.md) (planification des ressources).
- **Statut : Brouillon.**
...
- **Rattachement** : [ENF-1: Resilience a l'instabilite reseau](../../04_architecture-repository/exigences/enf-1.md), [F-1: Resilience face a la realite geographique du pays](../../04_architecture-repository/fondations/f-1.md).
- **Processus soutenus** : [PRC-04: Veille, prevention et surveillance sanitaire](../../04_architecture-repository/processus/prc-04.md) (veille et prevention), [PRC-05: Alerte, investigation et riposte](../../04_architecture-repository/processus/prc-05.md) (alerte et riposte).
- **Statut : Brouillon.**
...
- **Rattachement** : [ENF-1: Resilience a l'instabilite reseau](../../04_architecture-repository/exigences/enf-1.md), [F-1: Resilience face a la realite geographique du pays](../../04_architecture-repository/fondations/f-1.md).
- **Processus soutenus** : [PRC-04: Veille, prevention et surveillance sanitaire](../../04_architecture-repository/processus/prc-04.md) (veille terrain), [PRC-05: Alerte, investigation et riposte](../../04_architecture-repository/processus/prc-05.md) (alerte), [PRC-11: Suivi et pilotage de la performance](../../04_architecture-repository/processus/prc-11.md) (pilotage de la performance).
- **Statut : Brouillon.**
...
<!-- BEGIN:GENERATED mode=catalogue source=04_architecture-repository/composants/cmp-26.md,04_architecture-repository/composants/cmp-27.md,04_architecture-repository/composants/cmp-28.md,04_architecture-repository/composants/cmp-29.md,04_architecture-repository/composants/cmp-30.md,04_architecture-repository/composants/cmp-31.md -->
<!-- Généré par scripts/build_wrappers.py : ne pas éditer à la main -->
...
- **Rattachement** : [ART-7: Securite, controle d'acces et residence de la donnee](../../04_architecture-repository/chapitres/art-7.md).
- **Statut : Brouillon.**
...
<!-- BEGIN:GENERATED mode=catalogue source=04_architecture-repository/composants/cmp-32.md,04_architecture-repository/composants/cmp-33.md,04_architecture-repository/composants/cmp-34.md,04_architecture-repository/composants/cmp-35.md,04_architecture-repository/composants/cmp-36.md,04_architecture-repository/composants/cmp-37.md,04_architecture-repository/composants/cmp-38.md -->
<!-- Généré par scripts/build_wrappers.py : ne pas éditer à la main -->
...
<!-- BEGIN:GENERATED mode=catalogue source=04_architecture-repository/composants/cmp-39.md,04_architecture-repository/composants/cmp-40.md,04_architecture-repository/composants/cmp-41.md,04_architecture-repository/composants/cmp-42.md,04_architecture-repository/composants/cmp-43.md,04_architecture-repository/composants/cmp-44.md,04_architecture-repository/composants/cmp-45.md,04_architecture-repository/composants/cmp-46.md -->
<!-- Généré par scripts/build_wrappers.py : ne pas éditer à la main -->
...
- **Rattachement** : [ART-0: Accords de partage inter-institutionnels](../../04_architecture-repository/chapitres/art-0.md), [F-4: Homologation obligatoire](../../04_architecture-repository/fondations/f-4.md).
- **Statut : Brouillon.**
