...
Ces composants, marqués *Phase 2, candidat*, sont décrits dans le référentiel des composants (`04_architecture-repository/05_building-blocks/abb/legacy-components/`).
...
- [CMP-01 : Tableaux de bord & Portails nationaux (performance, CSU, ressources, veille)](../../04_architecture-repository/05_building-blocks/abb/legacy-components/cmp-01.md)
- [CMP-02 : Centre de commande & Crises intersectorielles (alertes, crises, veille)](../../04_architecture-repository/05_building-blocks/abb/legacy-components/cmp-02.md)
...
- [CMP-03 : Entrepôt Lakehouse & Projections analytiques (pipeline ETL, Lakehouse, projections)](../../04_architecture-repository/05_building-blocks/abb/legacy-components/cmp-03.md)
- [CMP-04 : Moteur analytique & IA (IA prédictive, routeur alertes, Grand Livre)](../../04_architecture-repository/05_building-blocks/abb/legacy-components/cmp-04.md)
- [CMP-05 : Moteur de graphes & Référentiel spatio-temporel (Graph Store, Spatio ART-4D)](../../04_architecture-repository/05_building-blocks/abb/legacy-components/cmp-05.md)
...
- [CMP-06 : Intégration, Médiation, API Gateway, Broker & Registre schémas](../../04_architecture-repository/05_building-blocks/abb/legacy-components/cmp-06.md)
- [CMP-07 : Orchestrateur de parcours & Gestionnaire de Sagas (ART-8A)](../../04_architecture-repository/05_building-blocks/abb/legacy-components/cmp-07.md)
- [CMP-08 : Répertoire de données cliniques opérationnelles](../../04_architecture-repository/05_building-blocks/abb/legacy-components/cmp-08.md)
- [CMP-09 : Référentiel des métadonnées d'exploitation (ART-4)](../../04_architecture-repository/05_building-blocks/abb/legacy-components/cmp-09.md)
- [CMP-10 : Registre des terminologies](../../04_architecture-repository/05_building-blocks/abb/legacy-components/cmp-10.md)
- [CMP-11 : Registre des clients / Index National des Patients (INP, ART-4A)](../../04_architecture-repository/05_building-blocks/abb/legacy-components/cmp-11.md)
- [CMP-12 : Registre d'éligibilité et de couverture (CSU, ART-4C)](../../04_architecture-repository/05_building-blocks/abb/legacy-components/cmp-12.md)
- [CMP-13 : Registre des personnels](../../04_architecture-repository/05_building-blocks/abb/legacy-components/cmp-13.md)
- [CMP-14 : Registre des produits, intrants et indicateurs](../../04_architecture-repository/05_building-blocks/abb/legacy-components/cmp-14.md)
...
- [CMP-15 : API Gateway](../../04_architecture-repository/05_building-blocks/abb/legacy-components/cmp-15.md)
- [CMP-16 : Registre de schémas (F.3)](../../04_architecture-repository/05_building-blocks/abb/legacy-components/cmp-16.md)
- [CMP-17 : Message broker asynchrone](../../04_architecture-repository/05_building-blocks/abb/legacy-components/cmp-17.md)
- [CMP-18 : Compensateur / Regroupeur de flux (Netting, ART-8C)](../../04_architecture-repository/05_building-blocks/abb/legacy-components/cmp-18.md)
...
- [CMP-19 : Dossiers & statistiques de santé (hôpitaux)](../../04_architecture-repository/05_building-blocks/abb/legacy-components/cmp-19.md)
- [CMP-20 : Gestion des pharmacies (PMIS)](../../04_architecture-repository/05_building-blocks/abb/legacy-components/cmp-20.md)
- [CMP-21 : Santé communautaire mobile (offline)](../../04_architecture-repository/05_building-blocks/abb/legacy-components/cmp-21.md)
- [CMP-22 : Espace santé patient](../../04_architecture-repository/05_building-blocks/abb/legacy-components/cmp-22.md)
- [CMP-23 : Chaîne logistique (LMIS)](../../04_architecture-repository/05_building-blocks/abb/legacy-components/cmp-23.md)
- [CMP-24 : Surveillance de la santé animale (zoonoses)](../../04_architecture-repository/05_building-blocks/abb/legacy-components/cmp-24.md)
- [CMP-25 : Enquêtes & capteurs terrain](../../04_architecture-repository/05_building-blocks/abb/legacy-components/cmp-25.md)

Références normatives : [ENF-1](../../04_architecture-repository/03_requirements/enf-1.md), [F.1](../../04_architecture-repository/04_patterns/foundations/f-1.md).
...
- [CMP-26 : Nœud central (datacenters nationaux HDS)](../../04_architecture-repository/05_building-blocks/abb/legacy-components/cmp-26.md)
- [CMP-27 : Nœuds régionaux (clusters de district : Fog)](../../04_architecture-repository/05_building-blocks/abb/legacy-components/cmp-27.md)
- [CMP-28 : Nœuds locaux (équipements chiffrés : Edge)](../../04_architecture-repository/05_building-blocks/abb/legacy-components/cmp-28.md)
- [CMP-29 : Liaisons dédiées & VPN](../../04_architecture-repository/05_building-blocks/abb/legacy-components/cmp-29.md)
- [CMP-30 : Réseau privé MPLS](../../04_architecture-repository/05_building-blocks/abb/legacy-components/cmp-30.md)
- [CMP-31 : Réseaux mobiles privés (APN sécurisés)](../../04_architecture-repository/05_building-blocks/abb/legacy-components/cmp-31.md)

Référence normative : [ART-7](../../04_architecture-repository/04_patterns/artsn-rules/art-7.md).
...
- [CMP-32 : Gestion des identités](../../04_architecture-repository/05_building-blocks/abb/legacy-components/cmp-32.md)
- [CMP-33 : Contrôle d'accès fin (RBAC/ABAC)](../../04_architecture-repository/05_building-blocks/abb/legacy-components/cmp-33.md)
- [CMP-34 : Gestion des consentements](../../04_architecture-repository/05_building-blocks/abb/legacy-components/cmp-34.md)
- [CMP-35 : Infrastructure de clés publiques (PKI)](../../04_architecture-repository/05_building-blocks/abb/legacy-components/cmp-35.md)
- [CMP-36 : Passerelle de confiance mondiale OMS (GDHCN)](../../04_architecture-repository/05_building-blocks/abb/legacy-components/cmp-36.md)
- [CMP-37 : Journal d'audit immuable](../../04_architecture-repository/05_building-blocks/abb/legacy-components/cmp-37.md)
- [CMP-38 : Moteur de chiffrement](../../04_architecture-repository/05_building-blocks/abb/legacy-components/cmp-38.md)
...
- [CMP-39 : Registre des accords inter-institutions](../../04_architecture-repository/06_governance/registers/cmp-39.md)
- [CMP-40 : Charte nationale de protection](../../04_architecture-repository/06_governance/registers/cmp-40.md)
- [CMP-41 : Conventions internationales](../../04_architecture-repository/06_governance/registers/cmp-41.md)
- [CMP-42 : Comité national d'homologation](../../04_architecture-repository/06_governance/registers/cmp-42.md)
- [CMP-43 : Registre des initiatives](../../04_architecture-repository/06_governance/registers/cmp-43.md)
- [CMP-44 : Comité d'éthique](../../04_architecture-repository/06_governance/registers/cmp-44.md)
- [CMP-45 : Cellule d'audit](../../04_architecture-repository/06_governance/registers/cmp-45.md)
- [CMP-46 : Arbitrage et risques](../../04_architecture-repository/06_governance/registers/cmp-46.md)
...
- **CMP-17** : Message broker asynchrone (`04_architecture-repository/05_building-blocks/abb/legacy-components/cmp-17.md`)
- **CMP-18** : Compensateur / Regroupeur de flux (Netting : ART-8C) (`04_architecture-repository/05_building-blocks/abb/legacy-components/cmp-18.md`)
- **CMP-19** : Dossiers & statistiques de sante (hopitaux) (`04_architecture-repository/05_building-blocks/abb/legacy-components/cmp-19.md`)
- **CMP-20** : Gestion des pharmacies (PMIS) (`04_architecture-repository/05_building-blocks/abb/legacy-components/cmp-20.md`)
- **CMP-21** : Sante communautaire mobile (offline) (`04_architecture-repository/05_building-blocks/abb/legacy-components/cmp-21.md`)
- **CMP-22** : Espace sante patient (`04_architecture-repository/05_building-blocks/abb/legacy-components/cmp-22.md`)
- **CMP-23** : Chaine logistique (LMIS) (`04_architecture-repository/05_building-blocks/abb/legacy-components/cmp-23.md`)
- **CMP-24** : Surveillance de la sante animale (zoonoses) (`04_architecture-repository/05_building-blocks/abb/legacy-components/cmp-24.md`)
- **CMP-25** : Enquetes & capteurs terrain (`04_architecture-repository/05_building-blocks/abb/legacy-components/cmp-25.md`)
- **CMP-26** : Noeud central (datacenters nationaux HDS) (`04_architecture-repository/05_building-blocks/abb/legacy-components/cmp-26.md`)
- **CMP-27** : Noeuds regionaux (clusters de district : Fog) (`04_architecture-repository/05_building-blocks/abb/legacy-components/cmp-27.md`)
- **CMP-28** : Noeuds locaux (equipements chiffres : Edge) (`04_architecture-repository/05_building-blocks/abb/legacy-components/cmp-28.md`)
- **CMP-29** : Liaisons dediees & VPN (`04_architecture-repository/05_building-blocks/abb/legacy-components/cmp-29.md`)
- **CMP-30** : Reseau prive MPLS (`04_architecture-repository/05_building-blocks/abb/legacy-components/cmp-30.md`)
- **CMP-31** : Reseaux mobiles prives (APN securises) (`04_architecture-repository/05_building-blocks/abb/legacy-components/cmp-31.md`)
- **CMP-32** : Gestion des identites (`04_architecture-repository/05_building-blocks/abb/legacy-components/cmp-32.md`)
- **CMP-33** : Controle d'acces fin (RBAC/ABAC) (`04_architecture-repository/05_building-blocks/abb/legacy-components/cmp-33.md`)
- **CMP-34** : Gestion des consentements (`04_architecture-repository/05_building-blocks/abb/legacy-components/cmp-34.md`)
- **CMP-35** : Infrastructure de cles publiques (PKI) (`04_architecture-repository/05_building-blocks/abb/legacy-components/cmp-35.md`)
- **CMP-36** : Passerelle de confiance mondiale OMS (GDHCN) (`04_architecture-repository/05_building-blocks/abb/legacy-components/cmp-36.md`)
- **CMP-37** : Journal d'audit immuable (`04_architecture-repository/05_building-blocks/abb/legacy-components/cmp-37.md`)
- **CMP-38** : Moteur de chiffrement (`04_architecture-repository/05_building-blocks/abb/legacy-components/cmp-38.md`)
- **CMP-39** : Registre des accords inter-institutions (`04_architecture-repository/06_governance/registers/cmp-39.md`)
- **CMP-40** : Charte nationale de protection (`04_architecture-repository/06_governance/registers/cmp-40.md`)
- **CMP-41** : Conventions internationales (`04_architecture-repository/06_governance/registers/cmp-41.md`)
- **CMP-42** : Comite national d'homologation (`04_architecture-repository/06_governance/registers/cmp-42.md`)
- **CMP-43** : Registre des initiatives (`04_architecture-repository/06_governance/registers/cmp-43.md`)
- **CMP-44** : Comite d'ethique (`04_architecture-repository/06_governance/registers/cmp-44.md`)
- **CMP-45** : Cellule d'audit (`04_architecture-repository/06_governance/registers/cmp-45.md`)
- **CMP-46** : Arbitrage et risques (`04_architecture-repository/06_governance/registers/cmp-46.md`)
- **F.1** : F.1 : Résilience face à la réalité géographique du pays (`04_architecture-repository/04_patterns/foundations/f-1.md`)
