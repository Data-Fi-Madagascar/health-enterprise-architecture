...
Chaque profil suit une structure standardisée composée de dix rubriques. L'identification initiale renseigne le code de l'initiative, son titre, son type, sa portée et son statut. Le rattachement aux objets CNISN/TOGAF et aux chapitres ART applicables permet de situer l'initiative dans le cadre national d'interopérabilité. La description de l'initiative précise son objectif, son contexte et ses parties prenantes. Les profils PTISN applicables identifient les patterns techniques requis. Les contrats d'interface spécifient les schémas, protocoles et formats d'échange. Les composants techniques décrivent l'infrastructure requise. Les indicateurs de bénéfice définissent les métriques de succès. Les risques et mitigations documentent les aléas identifiés et les mesures correctives. Enfin, le calendrier prévisionnel établit les jalons clés du projet.
...
| Capacité | Contribution |
|----------|--------------|
| **ABB-REGISTRE-PROFESSIONNELS** | Collecte et transmission des données |
| **ABB-SERVICE-TERMINOLOGIE** | Données agrégées de santé publique |
...
| Capacité | Contribution |
|----------|--------------|
| **ABB-REFERENTIEL-STRUCTURES-SERVICES** | Gestion des stocks et chaîne d'approvisionnement |
| **ABB-SERVICE-TERMINOLOGIE** | Données agrégées de santé publique |
