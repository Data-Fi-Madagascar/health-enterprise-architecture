...
Chaque fiche PT suit un modèle canonique de 13 sections : objet et périmètre, objet CNISN/TOGAF de référence, chapitres ART, **acteurs**, **transactions (R/O)**, **content modules**, **options**, service national, formats/standards, exigences, **déclaration de conformité (Integration Statement)**, articulation, limites.
...
<!-- BEGIN:GENERATED mode=table source=04_architecture-repository/05_building-blocks/sbb/legacy-profiles/pt-*.md -->
