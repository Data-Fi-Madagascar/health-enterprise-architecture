...
Catalogue des 19 profils techniques. Chaque profil est un objet du référentiel (`04_architecture-repository/05_building-blocks/sbb/legacy-profiles/pt-XX.md`) ; les numéros de capacité et de chapitres ART ont été alignés sur le CNISN et l'ARTSN pendant la migration (voir `coherence-report.md`).
