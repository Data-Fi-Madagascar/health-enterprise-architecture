...
L’interopérabilité nationale repose sur plusieurs couches complémentaires.
    ...
    Applications et systèmes du secteur santé
                   │
                   ▼
    Couche de médiation sectorielle
    Normalisation, routage, orchestration légère
                   │
           ┌───────┴─────────┐
           ▼                 ▼
    Services et registres    Services analytiques
    nationaux de santé       et de restitution
           │
           ▼
    Point d’échange sectoriel sécurisé
           │
           ▼
    Plateforme nationale d’échange interinstitutionnel
           │
           ▼
    Institutions et registres d’autres secteurs
