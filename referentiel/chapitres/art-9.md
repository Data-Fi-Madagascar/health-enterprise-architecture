...
owner: DEPSI
version: "0.0.1"
source: 02_artsn/03_chapitres/art-9-garanties-transactionnelles.md
maps_to: ["cap-07"]
implements: []
applies_to: ["enf-2"]
related: []
tags: ['artsn', 'niveau-4', 'chapitre', 'art-9']
---
...
- **Rattachement** : recouvre partiellement [CAP-07](../capabilites/cap-07.md) (protection financière).
- **Équation cible** : entrées − sorties = solde.
- **Déduit selon** : [ENF-2](../exigences/enf-2.md) (grade comptable anti-fraude).
