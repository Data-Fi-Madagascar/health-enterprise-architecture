...
owner: DEPSI
version: "0.0.1"
source: 02_artsn/03_chapitres/art-4c-eligibilite-couverture.md
maps_to: ["cap-07"]
implements: []
applies_to: ["enf-2", "enf-1"]
related: ["art-4"]
tags: ['artsn', 'niveau-4', 'chapitre', 'art-4c']
---
...
- **Rattachement** : [CAP-07](../capabilites/cap-07.md) (protection financière, CSU).
- **Pattern cible** : modélisation temporelle SCD type 2.
- **Déduit selon** : [ENF-2](../exigences/enf-2.md) (anti-fraude) et [ENF-1](../exigences/enf-1.md) (autonomie locale).
