...
- [ART-7: sécurité.](../chapitres/art-7.md)curité.
...
- intégration avec le médiateur sectoriel ([PT-02: Profil technique national](pt-02.md)).
...
Le médiateur ([PT-02: Profil technique national](pt-02.md)) assure le routage et la transformation des messages.

L'orchestrateur ([PT-16: Orchestration de processus bornés](pt-16.md)) coordonne les processus métier multi-étapes et garantit la cohérence des parcours.
