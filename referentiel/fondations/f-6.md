...
- **Rattachement** : [CAP-13: Système d'information sanitaire, données et recherche](../capabilites/cap-13.md) (SIS, données, analytique).
- **Déduit selon** : [P-INT-18: Traçabilité différenciée](../principes/p-int-18.md) (traçabilité différenciée).
- **Statut : Provisoire.**