...
## 2. Position dans la hiérarchie architecturale
    ...
    Value streams, capacités et gouvernance
                 ...
                 ▼                       ▼
              CNISN                    ARTSN
    Principes, capacités,       Contrats de conformité
    gouvernance sectorielle     et patrons architecturaux
                 │                       │
                 └───────────┬───────────┘
                             ▼
                          PTISN
    Standards, profils, versions et
    candidats d’implémentation
                             │
                             ▼
           Spécifications propres aux initiatives
                             │
                             ▼
             Services et systèmes homologués
