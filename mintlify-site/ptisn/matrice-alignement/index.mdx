...
Cette section ferme la boucle de traçabilité en reliant chaque lot — défini dans le portefeuille CAESN (source de vérité : périmètre, séquence, financement) — à ses profils PTISN, aux chapitres ART et aux normes/ADR CNISN qu'il opérationnalise. Elle complète les sections 1–3 (PTISN ↔ CNISN ↔ ART) et la [vue de réalisation ARTSN des lots](/artsn/lots/index#9-trajectoire-cnisn-et-alignement-des-lots).
