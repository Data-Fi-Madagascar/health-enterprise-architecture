...
COMP-HOMOLOGATION-INTEROPERABILITE: Partage intersectoriel des données
...
*Référence - objet CNISN/TOGAF mis en œuvre : ABB-ECHANGE-MEDIATION.
## 5. Transactions
...
- **ARTSN — lots consommateurs** : [L1 — Infrastructure & sécurité](/artsn/lots/index), [L3 — Médiation & registres](/artsn/lots/index), [L7 — Coordination One Health](/artsn/lots/index)
