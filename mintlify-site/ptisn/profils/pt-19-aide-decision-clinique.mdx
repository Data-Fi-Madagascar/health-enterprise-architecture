...
- ABB-SERVICE-TERMINOLOGIE: Terminologie et codification
- CMP-08: Répertoire de données cliniques opérationnelles (source de vérité clinique)

## 3. Chapitres ART applicables

- ART-12: Aide à la décision clinique
...
- **ARTSN — lots consommateurs** : [L1 — Infrastructure & sécurité](/artsn/lots/index), [L2 — Applications terrain](/artsn/lots/index), [L4 — Analytique & pilotage](/artsn/lots/index)
