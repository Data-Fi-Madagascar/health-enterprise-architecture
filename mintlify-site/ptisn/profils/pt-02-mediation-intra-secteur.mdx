...
Le médiateur traite la sémantique et les règles sectorielles, puis route vers le point d’échange sectoriel et, le cas échéant, vers la plateforme interinstitutionnelle (PT-01).
...
Il s’appuie sur les services nationaux PT-04 (identité), PT-05 (professionnels), PT-07 (terminologie), PT-10 (autorisation), PT-11 (consentement).
...
- **ARTSN — lots consommateurs** : [L3 — Médiation & registres](/artsn/lots/index), [L7 — Coordination One Health](/artsn/lots/index)
