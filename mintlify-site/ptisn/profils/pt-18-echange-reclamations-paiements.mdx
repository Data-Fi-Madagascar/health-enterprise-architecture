...
*Référence - objet CNISN/TOGAF mis en œuvre : ABB-REGISTRE-PROFESSIONNELS.
## 5. Transactions
...
- **ARTSN — lots consommateurs** : [L1 — Infrastructure & sécurité](/artsn/lots/index), [L2 — Applications terrain](/artsn/lots/index), [L3 — Médiation & registres](/artsn/lots/index), [L4 — Analytique & pilotage](/artsn/lots/index)
