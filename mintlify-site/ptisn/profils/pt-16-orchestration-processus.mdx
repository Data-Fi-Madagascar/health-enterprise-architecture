...
- intégration avec le médiateur sectoriel (PT-02: médiation intra-secteur).
...
Le médiateur (PT-02) assure le routage et la transformation des messages. L’orchestrateur (PT-16) coordonne les processus métier multi-étapes et garantit la cohérence des parcours.
