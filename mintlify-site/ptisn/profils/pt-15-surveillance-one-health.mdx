...
- RD-DONNEES-ENVIRONNEMENTALES-CLIMAT: Surveillance et alertes multi-sectorielles
- CAP-18: Coordination intersectorielle (One Health)
- CAP-05: Terminologie et codification communes
...
*Référence - objet CNISN/TOGAF mis en œuvre : PART-ONE-HEALTH.
## 5. Transactions
...
| ART-11: Coordination intersectorielle | Chapitre ARTSN | Active |
| PART-ONE-HEALTH: Échanges intersectoriels One Health | Objet CNISN/TOGAF | Créée |
| CAP-18: Coordination intersectorielle (One Health) | Capabilité CAESN | Active |
