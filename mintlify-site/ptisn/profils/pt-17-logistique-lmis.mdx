...
- ABB-ECHANGE-LOGISTIQUE-LMIS: Échange et traçabilité de la chaîne d'approvisionnement sanitaire
...
*Référence - objet CNISN/TOGAF mis en œuvre : ABB-AUDIT-PROVENANCE.
## 5. Transactions
...
Le profil opérationnalise le chapitre ART-10: Logistique et les objets CNISN/TOGAF ABB-AUDIT-PROVENANCE: Provenance, audit et traçabilité et ABB-ECHANGE-LOGISTIQUE-LMIS: Échange et traçabilité de la chaîne d'approvisionnement, en s'appuyant sur le composant CMP-23: Chaîne logistique (LMIS) et conformément à l'exigence ENF-2: Intégrité des flux et traçabilité des valeurs. L'échange interopérable respecte la norme STD-0009.
...
- **ARTSN — lots consommateurs** : [L2 — Applications terrain](/artsn/lots/index), [L3 — Médiation & registres](/artsn/lots/index), [L4 — Analytique & pilotage](/artsn/lots/index)
