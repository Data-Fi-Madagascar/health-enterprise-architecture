...
Le portefeuille est matérialisé par le **registre national des initiatives numériques en santé**, outil de référence pour identifier, suivre, comparer, prioriser et arbitrer. Il couvre les initiatives existantes, en conception, pilotes, proposées par les partenaires, à généraliser, et à rationaliser. Les lots de déploiement **L1–L7** de la feuille de route HEA sont inscrits au registre comme initiatives de réalisation ; ils sont définis dans la feuille de route des lots (source de vérité : périmètre, séquence, financement).
...
- financement-tco: Méthode TCO et enveloppe de financement du portefeuille
- feuille-de-route-lots: Feuille de route des lots du portefeuille (déploiement HEA)
