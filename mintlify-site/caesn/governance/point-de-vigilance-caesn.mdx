...
La coordination intersectorielle s'appuie sur un référentiel normatif international : **Tripartite Plus OMS–WOAH–FAO–PNUE** et le **Règlement Sanitaire International (RSI)**. Ce référentiel n'est pas intégré au [registre des normes](/caesn/standards/index) du CAESN, alors qu'il conditionne la surveillance épidémique conjointe (ENF-4).
...
Lorsqu'une décision D-1 à D-5 entre en instruction, elle fait l'objet d'un [ADR (Architecture Decision Record)](/caesn/decisions/index) au statut `proposé`, puis `accepté` ou `appliqué` après arbitrage du Comité National d'Architecture Santé Numérique. Chaque ADR référencera cette note comme source de l'écart constaté.

## Liens

- [CAESN — capabilités](/caesn/capabilities/index)
- [CAESN — normes et standards](/caesn/standards/index)
- [CAESN — registre des ADR](/caesn/decisions/index)
