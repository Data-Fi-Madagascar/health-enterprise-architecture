...
4. Enregistrement sous forme d'ADR ([`../08_decisions/index.md`](/caesn/decisions/index)) ;
...
Un modèle de norme est proposé : [STD-0000 — modèle](/caesn/standards/std-0000-template).

## Registre des normes

| Code | Titre | Type | Statut |
|------|-------|------|--------|
| STD-0000 | [Modèle de norme](/caesn/standards/std-0000-template) | modèle | — |
