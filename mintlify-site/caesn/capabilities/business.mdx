...
Elle est **pivot** pour le parcours de soins et conditionne le bon déroulement du flux de valeur VS-01: Accéder à des services de santé essentiels, intégrés, équitables et de qualité.
...
Son absence fragilise la continuité des soins (VS-01: Accéder à des services de santé essentiels, intégrés, équitables et de qualité) et provoque des ruptures de parcours.

#### Scénarios couverts

| Scénario | Description | Profils consommés |
|----------|-------------|-------------------|
| **Référence (DO-07)** | Orientation d'un patient d'un niveau de soins vers un autre (CSB → hôpital régional) | PT-01: Profil technique national, PT-02: Profil technique national |
| **Contre-référence (DO-08)** | Retour du patient vers l'établissement d'origine avec compte-rendu et recommandations | PT-01: Profil technique national, PT-02: Profil technique national |
| **Évacuation sanitaire nationale (DO-09)** | Transfert urgent entre établissements nationaux | PT-01: Profil technique national, PT-02: Profil technique national, PT-11: Profil technique national |
| **Évacuation sanitaire internationale (DO-09)** | Transfert vers un centre spécialisé à l'étranger | PT-01: Profil technique national, PT-02: Profil technique national, PT-11: Profil technique national, PT-14: Interopérabilité transfrontalière |
...
Elle alimente à la fois la qualité des soins (VS-01: Accéder à des services de santé essentiels, intégrés, équitables et de qualité) et le pilotage du système (VS-04: Piloter, coordonner et améliorer la performance du système de santé).
...
Son absence fragilise la surveillance sanitaire (VS-02: Prévenir, détecter et répondre aux risques sanitaires).
...
Son absence fragilise la prévention et la surveillance sanitaire (VS-02: Prévenir, détecter et répondre aux risques sanitaires).
...
Son absence fragilise la protection financière des ménages (VS-03: Protéger financièrement la population face aux dépenses de santé).
...
Son absence fragilise le pilotage du système (VS-04: Piloter, coordonner et améliorer la performance du système de santé) et la protection financière (VS-03: Protéger financièrement la population face aux dépenses de santé).
