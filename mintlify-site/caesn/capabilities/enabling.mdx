...
- La **rémunération et la paie** s'appuient sur le registre des professionnels (ABB-REGISTRE-PROFESSIONNELS: Registre et résolution des professionnels de santé) et sur l'échange financier ([PT-18: Échange de réclamations et paiements](/ptisn/profils/pt-18-echange-reclamations-paiements)).
