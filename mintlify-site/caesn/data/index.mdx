...
| Document | Contenu |
|----------|---------|
| [Principes de l'architecture des données](/caesn/data/principles) | Règles DA-01 à DA-08 |
| [Domaines de données](/caesn/data/domains) | Domaines de données prioritaires et stewards |
| [Référentiels nationaux](/caesn/data/referentials) | Socles communs aux systèmes sanitaires |
| [Cycle de vie des données](/caesn/data/lifecycle) | De la création à l'archivage |
| [Gouvernance et protection des données](/caesn/data/governance) | Rôles, qualité, accès, protection, entrepôt national |
