...
> **Source de vérité des lots** : le périmètre, la séquence et le financement des lots L1–L7 sont définis au niveau du portefeuille CAESN (niveau 1). Cette page détaille la **réalisation technique** de chaque lot : composants, patterns ARTSN et normes CNISN qu'il opérationnalise.
...
Le budget par lot est défini et propriété du portefeuille CAESN via la méthode TCO (niveau 1). L'ARTSN ne fixe pas le budget : il *réalise* les lots. Voir le devis TCO indicatif par lot.
...
|--------|-----|---------|-------------------|-----------|
| WP-01 | L1 — Infrastructure & sécurité | T4 2026 – T2 2027 | CMP-26, CMP-32, CMP-39, ABB-IDENTITE-BENEFICIAIRE, SRV-04 | wk-01 |
| WP-02 | L2 — Applications terrain & collecte | T2 2027 – T4 2027 | CMP-09, CMP-23, SRV-02, SRV-05, CAP-01 | wk-02 |
| WP-03 | L3 — Médiation & registres | T4 2027 – T2 2028 | CMP-10, CMP-11, SRV-03, SRV-04, ABB-ECHANGE-MEDIATION | wk-03 |
| WP-04 | L4 — Analytique & pilotage | T2 2028 – T4 2028 | CMP-12, SRV-06, CAP-03, ART-6 | wk-04 |
| WP-05 | L5 — Extension & pérennisation | T4 2028 – T2 2029 | SRV-06, CAP-03, ABB-CONFIANCE-AUTORISATION, PT-14, PT-15 | wk-05 |
| WP-06 | L6 — Interopérabilité transfrontalière | T2 2029 – T4 2029 | SRV-04, ABB-CONFIANCE-AUTORISATION, ART-9, PT-14 | wk-06 |
| WP-07 | L7 — Coordination One Health | T2 2029 – T4 2029 | CMP-02, ART-8B, CAP-03, PT-15 | wk-07 |

### 10.2 Plateaux de la feuille de route

| Plateau | État cible | Réalise | Précède | Enveloppe |
|---------|------------|---------|---------|-----------|
| PL-01 | Socle & confiance numérique | ABB-IDENTITE-BENEFICIAIRE, CAP-17 | PL-02 | pl-01 |
| PL-02 | Services de terrain & interopérabilité | CAP-01, ABB-ECHANGE-MEDIATION | PL-03 | pl-02 |
| PL-03 | Intelligence & ouverture | CAP-03, ABB-CONFIANCE-AUTORISATION, ABB-AUDIT-PROVENANCE | — | pl-03 |

### 10.3 Écarts (gaps) de couverture

| Écart | Entre | Description | Enveloppe |
|-------|-------|-------------|-----------|
| GAP-01 | PL-01 → PL-02 | Couverture terrain en zone isolée (connectivité contrainte) | gap-01 |
| GAP-02 | PL-02 → PL-03 | Interopérabilité transfrontalière & One Health | gap-02 |
| GAP-03 | état initial → PL-01 | Cadre légal & gouvernance publié (décret CNASN) | gap-03 |
