...
**Couches mobilisées** : Couche 1 (Infrastructure), Couche 2 (Point de service), Couche 3 (Échange, transport & ingestion), Couche 4 (Interopérabilité & services partagés).
...
**Couches mobilisées** : Couche 3 (Échange, transport & ingestion), Couche 4 (Interopérabilité & services partagés), Couche 5 (Projections analytiques & Modèles), Couche 6 (Pilotage, gouvernance & actions intersectorielles).
...
**Couches mobilisées** : Couche 2 (Point de service), Couche 4 (Interopérabilité & services partagés), Couche 5 (Projections analytiques & Modèles).
...
**Couches mobilisées** : Couche 4 (Interopérabilité & services partagés), Couche 5 (Projections analytiques & Modèles), Couche 6 (Pilotage, gouvernance & actions intersectorielles).
