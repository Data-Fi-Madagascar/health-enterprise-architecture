...
**Statut : Stable.** — appliqué par F.1, ART-1, [Couche 2 (point de service)](/artsn/cartographie-cible#couche-2--point-de-service).
...
**Statut : Stable.** — appliqué par ART-8a (orchestration de processus borné), ART-5 (qualité des données).
