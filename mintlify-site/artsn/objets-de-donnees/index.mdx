...
- **Capacités intégrées (CNISN)** : PART-ECHANGE-TRANSFRONTALIER (interopérabilité transfrontalière)
...
Ce concept est mobilisé par les capacités PART-ECHANGE-TRANSFRONTALIER et contribue aux flux de valeur VS-01. Il est porté par l'objet métier BO-07 : Interopérabilité transfrontalière et traité dans les chapitres ARTSN ART-2, ART-7.
...
- **Capacités intégrées (CNISN)** : PART-ECHANGE-TRANSFRONTALIER
- **Flux de valeur** : VS-01
- **Profils (PTISN)** : PT-14
- **Objet métier CAESN** : BO-07 : Interopérabilité transfrontalière
- **Chapitres ARTSN** : ART-2, ART-7
