...
L'architecture conceptuelle présentée dans cette section est l'incarnation visuelle et l'application physique stricte des contraintes et des patterns définis dans les [chapitres](/artsn/chapitres/index). Chaque bloc horizontal et vertical exécute techniquement un ou plusieurs chapitres normatifs de l'ARTSN.

La cartographie est structurée en **six couches horizontales** (de l'infrastructure à la gouvernance) traversées par **deux axes verticaux** transversaux. Elle s'articule avec les [six couches applicatives du CAESN](/caesn/application/layers).
...
- **Rattachement** : support du flux de valeur 4 ([VS-04](/artsn/flux-de-valeur#vs-04--piloter-coordonner-et-améliorer-la-performance-du-système-de-santé)).
...
- **Rattachement** : application du principe d'autonomie locale ([ENF-1](/artsn/exigences-contextuelles#enf-1--résilience-à-l-instabilité-réseau)) et de l'historisation à la source (F.1).
...
- [CAESN — couches applicatives](/caesn/application/layers)
- [VS-04 — Pilotage](/artsn/flux-de-valeur)
