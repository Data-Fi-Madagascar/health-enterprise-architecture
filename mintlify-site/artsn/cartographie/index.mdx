...
- CMP-01 : Tableaux de bord & Portails nationaux (performance, CSU, ressources, veille)
- CMP-02 : Centre de commande & Crises intersectorielles (alertes, crises, veille)
...
- CMP-19 : Dossiers & statistiques de santé (hôpitaux)
- CMP-20 : Gestion des pharmacies (PMIS)
- CMP-21 : Santé communautaire mobile (offline)
- CMP-22 : Espace santé patient
- CMP-23 : Chaîne logistique (LMIS)
- CMP-24 : Surveillance de la santé animale (zoonoses)
- CMP-25 : Enquêtes & capteurs terrain

Références normatives : ENF-1, F.1.
...
- CMP-26 : Nœud central (datacenters nationaux HDS)
- CMP-27 : Nœuds régionaux (clusters de district : Fog)
- CMP-28 : Nœuds locaux (équipements chiffrés : Edge)
- CMP-29 : Liaisons dédiées & VPN
- CMP-30 : Réseau privé MPLS
- CMP-31 : Réseaux mobiles privés (APN sécurisés)

Référence normative : ART-7.
...
- CMP-32 : Gestion des identités
- CMP-33 : Contrôle d'accès fin (RBAC/ABAC)
- CMP-34 : Gestion des consentements
- CMP-35 : Infrastructure de clés publiques (PKI)
...
- CMP-42 : Comité national d'homologation
- CMP-43 : Registre des initiatives
- CMP-44 : Comité d'éthique
