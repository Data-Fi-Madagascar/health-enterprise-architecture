...
- **Rattachement** : ART-6 (projections analytiques), CAP-INT-07: Accès et exposition des données analytiques, CAP-INT-11: Qualité et réconciliation.
...
- **Rattachement** : ART-5 (routeur alertes), ART-0 (accords partage), CAP-INT-07: Accès et exposition des données analytiques.
...
- **Rattachement** : ART-6 (CQRS), ART-9 (Grand Livre), CAP-INT-07: Accès et exposition des données analytiques, CAP-INT-11: Qualité et réconciliation.
...
- **Rattachement** : ART-5 (alertes), ART-9 (Grand Livre), CAP-INT-07: Accès et exposition des données analytiques, CAP-INT-10: Provenance, audit et traçabilité.
...
- **Rattachement** : ART-8B (graphe), ART-4D (spatio-temporel), CAP-INT-03: Échange et médiation inter-systèmes, CAP-INT-12: Conformité et tests d’interopérabilité.
- **Statut : Stable.**
...
- **Rattachement** : ART-1 (ingestion), ART-2 (médiation), F.3 (schémas), CAP-INT-01: Résolution d’identité du bénéficiaire, CAP-INT-03: Échange et médiation inter-systèmes.
- **Statut : Stable.**
...
- **Rattachement** : ART-8A (orchestrateur de parcours), CAP-INT-08: Confiance, sécurité et autorisation.
...
- **Rattachement** : ART-4 (référentiel des métadonnées), CAP-INT-09: Gestion des consentements et bases d’autorisation.
...
- **Rattachement** : ART-4A (INP), CAP-INT-09: Gestion des consentements et bases d’autorisation.
- **Processus soutenus** : PRC-04: Veille, prévention et surveillance sanitaire (soins), PRC-05: Alerte, investigation et riposte (pharmacie), PRC-06: Clôture et capitalisation des épisodes (logistique).
- **Statut : Stable.**
...
- **Rattachement** : ART-4C (éligibilité/couverture), CAP-INT-09: Gestion des consentements et bases d’autorisation.
...
- **Rattachement** : ART-5 (routeur d'escalade), CAP-INT-10: Provenance, audit et traçabilité.
- **Processus soutenus** : PRC-04: Veille, prévention et surveillance sanitaire (soins), PRC-05: Alerte, investigation et riposte (pharmacie), PRC-06: Clôture et capitalisation des épisodes (logistique).
- **Statut : Stable.**
...
- **Rattachement** : ART-8C (Netting), CAP-INT-10: Provenance, audit et traçabilité.
- **Processus soutenus** : PRC-04: Veille, prévention et surveillance sanitaire (soins), PRC-05: Alerte, investigation et riposte (pharmacie), PRC-06: Clôture et capitalisation des épisodes (logistique).
- **Statut : Stable.**
