...
- **Rattachement** : ART-4C (éligibilité/couverture), CAP-07: Protection financière, couverture santé universelle. Aucun ABB distinct ne modélise encore le registre d'éligibilité : le rattachement direct à la capacité évite de le confondre avec le consentement ou l'identité.
...
- **Rattachement** : ART-4 (référentiel des métadonnées), ABB-SERVICE-TERMINOLOGIE: Service de terminologie et codification communes pour les nomenclatures, et ABB-ECHANGE-LOGISTIQUE-LMIS: Échange logistique LMIS pour le catalogue partagé des produits et intrants.
- **Processus soutenus** : PRC-05: Alerte, investigation et riposte (pharmacie), PRC-06: Clôture et capitalisation des épisodes (logistique).
- **Statut : Stable.**
...
- **Rattachement** : ART-5 (routeur d'escalade), ABB-AUDIT-PROVENANCE: Provenance, audit et traçabilité.
- **Processus soutenus** : PRC-04: Veille, prévention et surveillance sanitaire (soins), PRC-05: Alerte, investigation et riposte (pharmacie), PRC-06: Clôture et capitalisation des épisodes (logistique).
- **Statut : Stable.**
...
- **Rattachement** : ART-8C (Netting), ABB-AUDIT-PROVENANCE: Provenance, audit et traçabilité.
- **Processus soutenus** : PRC-04: Veille, prévention et surveillance sanitaire (soins), PRC-05: Alerte, investigation et riposte (pharmacie), PRC-06: Clôture et capitalisation des épisodes (logistique).
- **Statut : Stable.**
...
- **Rattachement** : ENF-1: Resilience a l'instabilite reseau, F-1: Resilience face a la realite geographique du pays.
- **Processus soutenus** : PRC-01: Acces, orientation et admission du patient (acces et admission), PRC-02: Prestation des soins cliniques (prestation des soins), PRC-03: Continuite, suivi et qualite des soins (suivi et qualite), PRC-06: Cloture et capitalisation des episodes (cloture et capitalisation).
- **Statut : Brouillon.**
...
- **Rattachement** : ENF-1: Resilience a l'instabilite reseau, F-1: Resilience face a la realite geographique du pays.
- **Processus soutenus** : PRC-02: Prestation des soins cliniques (dispensation aux soins), PRC-05: Alerte, investigation et riposte (pharmacovigilance et riposte).
- **Statut : Brouillon.**
...
- **Rattachement** : ENF-1: Resilience a l'instabilite reseau, F-1: Resilience face a la realite geographique du pays.
- **Processus soutenus** : PRC-01: Acces, orientation et admission du patient (acces au beneficiaire), PRC-02: Prestation des soins cliniques (soins de proximite), PRC-03: Continuite, suivi et qualite des soins (suivi communautaire).
- **Statut : Brouillon.**
...
- **Rattachement** : ENF-1: Resilience a l'instabilite reseau, F-1: Resilience face a la realite geographique du pays.
- **Processus soutenus** : PRC-01: Acces, orientation et admission du patient (acces aux services), PRC-07: Identification et droits des beneficiaires (identification et droits), PRC-08: Financement et exemption au point de service (financement et exemption).
- **Statut : Brouillon.**
...
- **Rattachement** : ABB-ECHANGE-LOGISTIQUE-LMIS: Echange logistique LMIS, ART-10: Logistique, ENF-1: Resilience a l'instabilite reseau, F-1: Resilience face a la realite geographique du pays. ABB-AUDIT-PROVENANCE encadre la tracabilite transverse, sans remplacer le bloc logistique principal.
- **Processus soutenus** : PRC-05: Alerte, investigation et riposte (approvisionnement et riposte), PRC-10: Planification et allocation des ressources (planification des ressources).
- **Statut : Brouillon.**
...
- **Rattachement** : ENF-1: Resilience a l'instabilite reseau, F-1: Resilience face a la realite geographique du pays.
- **Processus soutenus** : PRC-04: Veille, prevention et surveillance sanitaire (veille et prevention), PRC-05: Alerte, investigation et riposte (alerte et riposte).
- **Statut : Brouillon.**
...
- **Rattachement** : ENF-1: Resilience a l'instabilite reseau, F-1: Resilience face a la realite geographique du pays.
- **Processus soutenus** : PRC-04: Veille, prevention et surveillance sanitaire (veille terrain), PRC-05: Alerte, investigation et riposte (alerte), PRC-11: Suivi et pilotage de la performance (pilotage de la performance).
- **Statut : Brouillon.**
...
- **Rattachement** : ART-7: Securite, controle d'acces et residence de la donnee.
- **Statut : Brouillon.**
...
- **Rattachement** : ART-0: Accords de partage inter-institutionnels, F-4: Homologation obligatoire.
- **Statut : Brouillon.**
