...
- **Rattachement** : CAP-10: Gestion des médicaments, vaccins, intrants et chaîne d'approvisionnement (chaîne d'approvisionnement), CAP-11: Gestion des infrastructures, équipements et maintenance (infrastructures et équipements).
- **Modèles cibles** : événementisation des mouvements de stock, registres logistiques (ex. OpenLMIS), traçabilité par lot.
- **Déduit selon** : ENF-2: Intégrité des flux et traçabilité des valeurs (traçabilité des valeurs).
- **Statut : Provisoire.**
...
- PT-17 : Logistique & chaîne d'approvisionnement (LMIS)
