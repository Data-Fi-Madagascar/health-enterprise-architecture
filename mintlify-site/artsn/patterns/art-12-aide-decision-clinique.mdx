...
- **Rattachement** : CMP-08: Répertoire de données cliniques opérationnelles (source de vérité clinique).
- **Terminologie** : ABB-SERVICE-TERMINOLOGIE: Terminologie et codification, [STD-0007: SNOMED CT](/cnisn/standards/std-0007-snomed-ct).
- **Référentiel cible** : HL7 CDS Hooks, FHIR Clinical Reasoning Module, guides de pratique profilés.
- **Déduit selon** : ART-6: Analytique et restitution (restitution de la connaissance), CAP-13: Système d'information sanitaire, données et recherche.
