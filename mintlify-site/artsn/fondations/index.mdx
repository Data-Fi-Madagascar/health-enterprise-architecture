...
**Contenu normatif.** Le processus d’homologation obligatoire (introduit en F.3) s’applique à toute solution ; un constat d’homologation qui révélerait qu’un composant ne peut être rattaché à aucun chapitre existant déclenche une revue de l’ARTSN (voir [Gouvernance](/artsn/gouvernance/index)).
...
- **Rattachement** : CAP-15: Cybersécurité, confidentialité et gouvernance des données personnelles (cybersécurité, confidentialité, gouvernance des données personnelles).
- **Déduit selon** : P-INT-16: Résidence et non-réplication (résidence et non-réplication), P-INT-17: Minimisation (minimisation).
- **Statut : Provisoire.**
...
- **Rattachement** : CAP-13: Système d'information sanitaire, données et recherche (SIS, données, analytique).
- **Déduit selon** : P-INT-18: Traçabilité différenciée (traçabilité différenciée).
- **Statut : Provisoire.**
