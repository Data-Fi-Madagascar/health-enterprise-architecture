...
- CAP-14: Interopérabilité, référentiels nationaux et infrastructure numérique partagée — Interopérabilité, référentiels nationaux et infrastructure numérique partagée
- CAP-15: Cybersécurité, confidentialité et gouvernance des données personnelles — Cybersécurité, confidentialité et gouvernance des données personnelles

#### Parties prenantes concernées

- PP-05: Agent de santé — Agent de santé
- PP-06: Formation sanitaire — Formation sanitaire
- PP-10: Équipes techniques (DEPSI / SIS) — Équipes techniques (DEPSI / SIS)

#### Fondations et chapitres garants

- **F.1** — Résilience face à la réalité géographique du pays
- ART-1: Intégration et ingestion — Intégration et ingestion
- ART-3: Historisation événementielle et profils de déploiement — Historisation événementielle et profils de déploiement
- ART-7: Sécurité, contrôle d'accès et résidence de la donnée — Sécurité, contrôle d'accès et résidence de la donnée
...
- CAP-12: Finances publiques, budget et allocation des ressources — Finances publiques, budget et allocation des ressources
- CAP-13: Système d'information sanitaire, données et recherche — Système d'information sanitaire, données et recherche

#### Parties prenantes concernées

- PP-02: Ménage et famille — Ménage et famille
- PP-06: Formation sanitaire — Formation sanitaire
- PP-08: Partenaires techniques et financiers — Partenaires techniques et financiers

#### Fondations et chapitres garants

- ART-9: Garanties transactionnelles fortes — Garanties transactionnelles fortes
- **ART-4C** — Éligibilité et couverture
- **ART-8C** — Agrégation par lot
...
- PP-01: Patient et usager — Patient et usager
- PP-06: Formation sanitaire — Formation sanitaire
- PP-10: Équipes techniques (DEPSI / SIS) — Équipes techniques (DEPSI / SIS)
...
- ART-2: Médiation et normalisation — Médiation et normalisation
...
- PP-03: Population — Population
- PP-07: District, région et Ministère — District, région et Ministère
- PP-08: Partenaires techniques et financiers — Partenaires techniques et financiers
- PP-10: Équipes techniques (DEPSI / SIS) — Équipes techniques (DEPSI / SIS)

#### Fondations et chapitres garants

- ART-0: Accords de partage inter-institutionnels — Accords de partage inter-institutionnels
...
- ART-2: Médiation et normalisation — Médiation et normalisation
- ART-6: Analytique et restitution — Analytique et restitution
- **ART-8B** — Modélisation de relations en graphe
- **ART-8D** — Chorégraphie inter-institutionnelle
- ART-4: Référentiels de métadonnées de gestion — Référentiels de métadonnées de gestion
...
**Statut : Stable.** — appliqué par ART-8A (orchestration de processus borné), ART-5 (qualité des données), [PT-14 (interopérabilité transfrontalière)](/ptisn/profils/pt-14-interopabilite-transfrontaliere).
...
- CAP-13: Système d'information sanitaire, données et recherche — Système d'information sanitaire, données et recherche
- CAP-16: Gestion du portefeuille d'initiatives numériques — Gestion du portefeuille d'initiatives numériques
...
- ART-8: Orchestration de processus — Orchestration de processus
- ART-5: Cohérence et qualité des données — Cohérence et qualité des données
