...
Composants d'usage décisionnel : entrepôt national, tableaux de bord, outils d'analyse, rapports nationaux, suivi des indicateurs et des bénéfices, revues de performance. Voir [entrepôt](../data/governance.md).
...
- [Référentiels](../data/referentials.md)
