...
| 2 | **CNISN** | Principes (P-INT, 25), objets d'interopérabilité TOGAF, standards (STD-0001…0007), décisions (ADR-0001…0010) |
...
- **CAESN ↔ CNISN** : correspondance `CAP-*` vers objets `ABB`/`PAT`/`REQ`/`PART` (`maps_to`) et `PA/PD ↔ P-INT`.
- **CNISN ↔ ARTSN** : objets d'interopérabilité TOGAF ↔ `ART` (`related`) ; `STD`/`ADR` alimentent fondations et chapitres.
