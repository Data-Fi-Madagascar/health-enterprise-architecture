...
**Statut : Stable.** — appliqué par [ART-8A (orchestration de processus borné)](../04_patterns/artsn-rules/art-8a.md), [ART-5 (qualité des données)](../04_patterns/artsn-rules/art-5.md), [PT-14 (interopérabilité transfrontalière)](../../03_ptisn/03_profils/pt-14-interopabilite-transfrontaliere.md).
...
- [CAP-02: Gestion du parcours patient, référence et contre-référence](../02_architecture-elements/strategy/capabilities/cap-02.md) — Gestion du parcours patient, référence et contre-référence
...
- [CAP-16: Gestion du portefeuille d'initiatives numériques](../02_architecture-elements/strategy/capabilities/cap-16.md) — Gestion du portefeuille d'initiatives numériques

## Parties prenantes concernées

- [PP-01: Patient et usager](../02_architecture-elements/motivation/stakeholders/pp-01.md) — Patient et usager
...
- [ART-8: Orchestration de processus](../04_patterns/artsn-rules/art-8.md) — Orchestration de processus
- [ART-5: Cohérence et qualité des données](../04_patterns/artsn-rules/art-5.md) — Cohérence et qualité des données
- [PT-14: Interopérabilité transfrontalière](../05_building-blocks/sbb/legacy-profiles/pt-14.md) — Interopérabilité transfrontalière
