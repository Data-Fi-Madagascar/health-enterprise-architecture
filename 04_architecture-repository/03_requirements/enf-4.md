...
**Statut : Stable.** — appliqué par [ART-0 (accords de partage)](../04_patterns/artsn-rules/art-0.md), [ART-4B (bases d’autorisation)](../04_patterns/artsn-rules/art-4b.md), [ART-4D (référentiel géospatial)](../04_patterns/artsn-rules/art-4d.md).
...
- [CAP-14: Interopérabilité, référentiels nationaux et infrastructure numérique partagée](../02_architecture-elements/strategy/capabilities/cap-14.md) — Interopérabilité, référentiels nationaux et infrastructure numérique partagée
...
- [CAP-15: Cybersécurité, confidentialité et gouvernance des données personnelles](../02_architecture-elements/strategy/capabilities/cap-15.md) — Cybersécurité, confidentialité et gouvernance des données personnelles

## Parties prenantes concernées

- [PP-03: Population](../02_architecture-elements/motivation/stakeholders/pp-03.md) — Population
- [PP-07: District, région et Ministère](../02_architecture-elements/motivation/stakeholders/pp-07.md) — District, région et Ministère
- [PP-08: Partenaires techniques et financiers](../02_architecture-elements/motivation/stakeholders/pp-08.md) — Partenaires techniques et financiers
- [PP-10: Équipes techniques (DEPSI / SIS)](../02_architecture-elements/motivation/stakeholders/pp-10.md) — Équipes techniques (DEPSI / SIS)

## Fondations et chapitres garants

- [ART-0: Accords de partage inter-institutionnels](../04_patterns/artsn-rules/art-0.md) — Accords de partage inter-institutionnels
...
- [ART-2: Médiation et normalisation](../04_patterns/artsn-rules/art-2.md) — Médiation et normalisation
- [ART-6: Analytique et restitution](../04_patterns/artsn-rules/art-6.md) — Analytique et restitution
- **ART-8B** — Modélisation de relations en graphe
- **ART-8D** — Chorégraphie inter-institutionnelle
- [ART-4: Référentiels de métadonnées de gestion](../04_patterns/artsn-rules/art-4.md) — Référentiels de métadonnées de gestion
