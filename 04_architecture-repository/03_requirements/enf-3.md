...
**Statut : Stable.** — appliqué par [ART-4A (résolution d’identité)](../04_patterns/artsn-rules/art-4a.md), [ART-2 (médiation)](../04_patterns/artsn-rules/art-2.md).
...
- [CAP-17: Engagement patient et identité numérique](../02_architecture-elements/strategy/capabilities/cap-17.md) — Engagement patient et identité numérique
