...
**Statut : Stable.** — appliqué par [F.1](../04_patterns/foundations/f-1.md), [ART-1](../04_patterns/artsn-rules/art-1.md), [Couche 2 (point de service)](../../02_artsn/05_cartographie/index.md#couche-2--point-de-service).
...
- [CAP-13: Système d'information sanitaire, données et recherche](../02_architecture-elements/strategy/capabilities/cap-13.md) — Système d'information sanitaire, données et recherche
...
- [PP-05: Agent de santé](../02_architecture-elements/motivation/stakeholders/pp-05.md) — Agent de santé
- [PP-06: Formation sanitaire](../02_architecture-elements/motivation/stakeholders/pp-06.md) — Formation sanitaire
...
- [ART-1: Intégration et ingestion](../04_patterns/artsn-rules/art-1.md) — Intégration et ingestion
- [ART-3: Historisation événementielle et profils de déploiement](../04_patterns/artsn-rules/art-3.md) — Historisation événementielle et profils de déploiement
- [ART-7: Sécurité, contrôle d'accès et résidence de la donnée](../04_patterns/artsn-rules/art-7.md) — Sécurité, contrôle d'accès et résidence de la donnée
