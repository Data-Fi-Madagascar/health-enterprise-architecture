...
- **Rattachement** : [CAP-10: Gestion des médicaments, vaccins, intrants et chaîne d'approvisionnement](../../02_architecture-elements/strategy/capabilities/cap-10.md) (chaîne d'approvisionnement), [CAP-11: Gestion des infrastructures, équipements et maintenance](../../02_architecture-elements/strategy/capabilities/cap-11.md) (infrastructures et équipements).
- **Modèles cibles** : événementisation des mouvements de stock, registres logistiques (ex. OpenLMIS), traçabilité par lot.
- **Déduit selon** : [ENF-2: Intégrité des flux et traçabilité des valeurs](../../03_requirements/enf-2.md) (traçabilité des valeurs).
- **Statut : Provisoire.**
...
- [PT-17 : Logistique & chaîne d'approvisionnement (LMIS)](../../05_building-blocks/sbb/legacy-profiles/pt-17.md)
