...
- **Déduit selon** : [ENF-3: Unicité de l'identité et résilience face à la fragmentation applicative](../../03_requirements/enf-3.md) (fragmentation applicative) et [ENF-4: Cloisonnement inter-institutionnel et étanchéité des données (One Health)](../../03_requirements/enf-4.md) (One Health).
- **Statut : Stable.**
...
- [PT-18 : Échange de réclamations et paiements](../../05_building-blocks/sbb/legacy-profiles/pt-18.md)
