...
maps_to: ["CAP-08", "CAP-18", "PART-ONE-HEALTH"]
implements: []
applies_to: ["ENF-4"]
related: ["ART-0", "ART-4D", "ART-8B", "ART-8D"]
tags: ["artsn", "niveau-3", "chapitre", "ART-11", "one-health"]
---
...
- **Rattachement** : [CAP-08: Gouvernance institutionnelle, planification, coordination et redevabilité](../../02_architecture-elements/strategy/capabilities/cap-08.md) (gouvernance, coordination, redevabilité), [CAP-18: Coordination intersectorielle (One Health)](../../02_architecture-elements/strategy/capabilities/cap-18.md) (Coordination intersectorielle — One Health), [PART-ONE-HEALTH: Échanges intersectoriels One Health](../../01_partitions/sectorielles/part-one-health.md) (Échanges intersectoriels One Health).
- **Modèles cibles** : accords de partage, chorégraphie inter-institutionnelle, espaces de rapprochement neutres.
- **Déduit selon** : [ENF-4: Cloisonnement inter-institutionnel et étanchéité des données (One Health)](../../03_requirements/enf-4.md) (cloisonnement inter-institutionnel One Health).
- **Statut : Stable.**
...
- [PT-11 : Consentement et bases d’autorisation](../../05_building-blocks/sbb/legacy-profiles/pt-11.md)
- [PT-15 : Surveillance One Health](../../05_building-blocks/sbb/legacy-profiles/pt-15.md)
