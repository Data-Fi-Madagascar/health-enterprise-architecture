...
- **Rattachement** : recouvre partiellement [CAP-07: Protection financière, couverture santé universelle](../../02_architecture-elements/strategy/capabilities/cap-07.md) (protection financière).
...
- **Déduit selon** : [ENF-2: Intégrité des flux et traçabilité des valeurs](../../03_requirements/enf-2.md) (grade comptable anti-fraude).
