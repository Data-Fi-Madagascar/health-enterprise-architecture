...
- **Rattachement** : [CAP-15: Cybersécurité, confidentialité et gouvernance des données personnelles](../../02_architecture-elements/strategy/capabilities/cap-15.md) (cybersécurité et gouvernance de la sécurité).
...
- **Déduit selon** : [ENF-1: Résilience à l'instabilité réseau](../../03_requirements/enf-1.md) (sécurité locale).
- **Statut : Stable.**
...
- [PT-04 : Résolution d’identité du bénéficiaire](../../05_building-blocks/sbb/legacy-profiles/pt-04.md)
- [PT-05 : Registre des professionnels](../../05_building-blocks/sbb/legacy-profiles/pt-05.md)
- [PT-09 : Analytique et exposition de données](../../05_building-blocks/sbb/legacy-profiles/pt-09.md)
- [PT-10 : Confiance, authentification et autorisation](../../05_building-blocks/sbb/legacy-profiles/pt-10.md)
- [PT-11 : Consentement et bases d’autorisation](../../05_building-blocks/sbb/legacy-profiles/pt-11.md)
- [PT-12 : Audit, provenance et traçabilité](../../05_building-blocks/sbb/legacy-profiles/pt-12.md)
