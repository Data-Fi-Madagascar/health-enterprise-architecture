...
- **Déduit selon** : [ENF-1: Résilience à l'instabilité réseau](../../03_requirements/enf-1.md) (réseau instable) et [ENF-2: Intégrité des flux et traçabilité des valeurs](../../03_requirements/enf-2.md) (anti-fraude).
