...
- **Rattachement** : [CAP-15: Cybersécurité, confidentialité et gouvernance des données personnelles](../../02_architecture-elements/strategy/capabilities/cap-15.md) (cybersécurité, confidentialité, gouvernance des données personnelles).
- **Déduit selon** : [P-INT-16: Résidence et non-réplication](../../02_architecture-elements/motivation/principles/p-int-16.md) (résidence et non-réplication), [P-INT-17: Minimisation](../../02_architecture-elements/motivation/principles/p-int-17.md) (minimisation).
- **Statut : Provisoire.**