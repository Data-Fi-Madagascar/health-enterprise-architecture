...
- **Rattachement** : [CAP-13: Système d'information sanitaire, données et recherche](../../02_architecture-elements/strategy/capabilities/cap-13.md) (SIS, données, analytique).
- **Déduit selon** : [P-INT-18: Traçabilité différenciée](../../02_architecture-elements/motivation/principles/p-int-18.md) (traçabilité différenciée).
- **Statut : Provisoire.**