...
maps_to: ["ABB-EXPOSITION-DONNEES-ANALYTIQUES", "CAP-05", "CAP-13"]
...
[ABB-EXPOSITION-DONNEES-ANALYTIQUES: Accès et exposition des données analytiques](../../abb/abb-exposition-donnees-analytiques.md)

## 3. Chapitres ART applicables

- [ART-3: Historisation événementielle et profils de déploiement](../../../04_patterns/artsn-rules/art-3.md) selon le profil retenu
...
*Référence - objet CNISN/TOGAF mis en œuvre : [ABB-EXPOSITION-DONNEES-ANALYTIQUES](../../abb/abb-exposition-donnees-analytiques.md).
## 5. Transactions
