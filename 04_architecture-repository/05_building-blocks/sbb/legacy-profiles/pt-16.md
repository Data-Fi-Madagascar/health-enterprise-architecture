...
version: "0.1"
envelope: 03_ptisn/03_profils/pt-16-orchestration-processus.md
maps_to: ["ABB-ECHANGE-MEDIATION", "CAP-13", "CAP-14", "CAP-18"]
implements: ["ART-8A", "ART-7"]
applies_to: ["CMP-07", "CMP-06"]
related: ["PT-02"]
tags: ["ptisn", "niveau-4", "profil", "PT-16", "orchestration", "workflow"]
---
...
- [ART-7: sécurité](../../../04_patterns/artsn-rules/art-7.md)
...
- intégration avec le médiateur sectoriel ([PT-02: médiation intra-secteur](pt-02.md)).
...
Le médiateur ([PT-02](pt-02.md)) assure le routage et la transformation des messages. L’orchestrateur ([PT-16](pt-16.md)) coordonne les processus métier multi-étapes et garantit la cohérence des parcours.
...
|Médiateur sectoriel ([PT-02](pt-02.md))|
:Route le message;

|Orchestrateur ([PT-16](pt-16.md))|
:Exécute le workflow;
:Gère les sagas
et compensations;
