...
maps_to: ["ABB-ECHANGE-MEDIATION", "COMP-HOMOLOGATION-INTEROPERABILITE", "CAP-13", "CAP-14", "CAP-18", "CAP-16"]
...
[ABB-ECHANGE-MEDIATION: Échange et médiation inter-systèmes](../../abb/abb-echange-mediation.md)

[COMP-HOMOLOGATION-INTEROPERABILITE: Partage intersectoriel des données](../../../06_governance/compliance/comp-homologation-interoperabilite.md)

## 3. Chapitres ART applicables

- [ART-0: accords de partage](../../../04_patterns/artsn-rules/art-0.md)
- [ART-1: intégration et ingestion](../../../04_patterns/artsn-rules/art-1.md)
- [ART-7: sécurité et résidence](../../../04_patterns/artsn-rules/art-7.md)
...
*Référence - objet CNISN/TOGAF mis en œuvre : [ABB-ECHANGE-MEDIATION](../../abb/abb-echange-mediation.md).
## 5. Transactions
...
- [PT-16: orchestration de processus](pt-16.md)
