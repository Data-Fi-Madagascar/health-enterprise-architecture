...
version: "0.4"
envelope: 03_ptisn/03_profils/pt-13-qualite-reconciliation.md
maps_to: ["ABB-RECONCILIATION-DONNEES", "CAP-13", "CAP-14"]
...
- [ABB-RECONCILIATION-DONNEES: Qualité et réconciliation](../../abb/abb-reconciliation-donnees.md)
...
*Référence - objet CNISN/TOGAF mis en œuvre : [ABB-RECONCILIATION-DONNEES](../../abb/abb-reconciliation-donnees.md).
## 5. Transactions
...
- [PT-03: catalogue des services et registre des contrats](pt-03.md)
