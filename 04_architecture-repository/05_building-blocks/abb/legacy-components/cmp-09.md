...
niveau: "1"
title: Référentiel des métadonnées d'exploitation (ART-4)
status: active
owner: DEPSI
version: "0.0.1"
...
realized_by: ["WP-02"]
---
# Référentiel des métadonnées d'exploitation ([ART-4: Référentiels de métadonnées de gestion](../../../04_patterns/artsn-rules/art-4.md))
