...
Service de catégorie *technologique*, il [sert l'équipe technique DEPSI / SIS](../../../02_architecture-elements/motivation/stakeholders/pp-10.md), [réalise la capacité « Interopérabilité et échanges »](../../../capacites/cap-int-08.md), [accède à l'objet de données d'échange](../../../02_architecture-elements/data/data-objects/do-03.md) et [met en œuvre le chapitre ART-9 (échange)](../../../04_patterns/artsn-rules/art-9.md). Il s'appuie sur le [composant de médiation / transport](../legacy-components/cmp-11.md).
...
Réalisé par les capacités [CAP-INT-08](../../../capacites/cap-int-08.md) et mis en œuvre via les chapitres [ART-9](../../../04_patterns/artsn-rules/art-9.md).
