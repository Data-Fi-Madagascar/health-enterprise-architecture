...
| **Chapitres ARTSN** | [ART-7: Sécurité](../chapitres/art-7.md), [ART-0: Accords](../chapitres/art-0.md), [ART-1: Intégration](../chapitres/art-1.md) |
...
- [CAP-17: Engagement patient et identité numérique](../capabilites/cap-17.md)
...
| Propriété | Valeur |
|-----------|--------|
| **Producteur** | [CMP-15: API Gateway](../composants/cmp-15.md) |
...
| Propriété | Valeur |
|-----------|--------|
| **Producteur** | [CMP-06: Intégration/Médiation](../composants/cmp-06.md) |
...
| Propriété | Valeur |
|-----------|--------|
| **Producteur** | [CMP-11: INP](../composants/cmp-11.md) |
| **Consommateur** | [CMP-06: Médiation](../composants/cmp-06.md) → Système partenaire |
...
| **Prérequis** | Accord bilatéral ([ART-0: Accords de partage inter-institutionnels](../chapitres/art-0.md)) + autorisation de sortie du territoire |
...
| **Règle 3** | Tout flux sortant doit être couvert par un accord bilatéral ou multilatéral explicite ([ART-0: Accords de partage inter-institutionnels](../chapitres/art-0.md)) |
...
| **EXG-S5** | Accord de partage ([ART-0: Accords de partage inter-institutionnels](../chapitres/art-0.md)) préalable à tout flux sortant |
...
| [ART-7: Sécurité](../chapitres/art-7.md) | Chapitre ARTSN | Active |
| [ART-0: Accords de partage](../chapitres/art-0.md) | Chapitre ARTSN | Active |
| [CAP-INT-13: Interopérabilité transfrontalière](../capacites/cap-int-13.md) | Capacité CNISN | Créée |
| [CAP-15: Cybersécurité](../capabilites/cap-15.md) | Capabilité CAESN | Active |
| [CAP-17: Engagement patient](../capabilites/cap-17.md) | Capabilité CAESN | Active |
