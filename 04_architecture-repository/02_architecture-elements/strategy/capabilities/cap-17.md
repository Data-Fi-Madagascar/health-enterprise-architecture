...
Cette capabilité est **habilitante** : son absence bloque la continuité des soins ([VS-01: Accéder à des services de santé essentiels, intégrés, équitables et de qualité](../value-streams/vs-01.md)) et la protection financière ([VS-03: Protéger financièrement la population face aux dépenses de santé](../value-streams/vs-03.md)).
