...
type: capabilite
niveau: "1"
title: Santé communautaire et engagement des communautés
status: stable
...
related: []
tags: ["caesn", "niveau-1", "capabilite", "CAP-04"]
---
...
Elle renforce la couverture sanitaire sur les flux [VS-01: soins](../value-streams/vs-01.md) et [VS-02: surveillance](../value-streams/vs-02.md).
...
- [ART-2: Médiation et normalisation](../../../04_patterns/artsn-rules/art-2.md)
- [PT-02: Profil technique national](../../../05_building-blocks/sbb/legacy-profiles/pt-02.md)
- [F-6: Observabilité](../../../04_patterns/foundations/f-6.md)
