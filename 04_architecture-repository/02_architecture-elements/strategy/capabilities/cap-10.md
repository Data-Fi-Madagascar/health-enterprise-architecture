...
type: capabilite
niveau: "1"
title: Gestion des médicaments, vaccins, intrants et chaîne d'approvisionnement
status: stable
...
Son absence expose le système à des ruptures de stock qui compromettent les soins ([VS-01: Accéder à des services de santé essentiels, intégrés, équitables et de qualité](../value-streams/vs-01.md)) et la prévention ([VS-02: Prévenir, détecter et répondre aux risques sanitaires](../value-streams/vs-02.md)).
