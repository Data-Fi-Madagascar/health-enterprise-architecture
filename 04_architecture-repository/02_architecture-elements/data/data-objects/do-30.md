...
Ce concept est mobilisé par les capacités [CAP-INT-13](../../../capacites/cap-int-13.md) et contribue aux flux de valeur [VS-01](../../strategy/value-streams/vs-01.md). Il est porté par l'objet métier [BO-07 : Interopérabilité transfrontalière](../../business/business-objects/bo-07.md) et traité dans les chapitres ARTSN [ART-2](../../../04_patterns/artsn-rules/art-2.md), [ART-7](../../../04_patterns/artsn-rules/art-7.md).
