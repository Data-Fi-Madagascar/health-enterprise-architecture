...
Service de catégorie *applicatif*, il [sert l'autorité district, région et Ministère](../parties-prenantes/pp-07.md), [réalise la capacité « Pilotage et performance »](../capabilites/cap-03.md), [accède à l'objet de données de pilotage](../objets-de-donnees/do-04.md) et [met en œuvre le chapitre ART-3 (pilotage)](../chapitres/art-3.md). Il s'appuie sur le [composant de pilotage](../composants/cmp-12.md).
...
Sert la partie prenante [PP-07](../parties-prenantes/pp-07.md) et crée de la valeur pour son bénéficiaire.

## Réalisation

Réalisé par les capacités [CAP-03](../capabilites/cap-03.md) et mis en œuvre via les chapitres [ART-3](../chapitres/art-3.md).
